...
/// Takes in R,G,B values or hex string and returns a hex color string.
...
/// Takes in a 0 to 255 value or hex string and returns a hex color string.
/datum/category_item/player_setup_item/proc/alpha_square(alpha, hex)
	var/color = hex ? hex : "#[num2hex(alpha, 2)][num2hex(alpha, 2)][num2hex(alpha, 2)]"
	return "<span style='font-face: fixedsys; font-size: 14px; background-color: [color]; color: [color]'>___</span>"
