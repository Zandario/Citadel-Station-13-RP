...
/datum/category_item/player_setup_item/player_global/ui/load_preferences(savefile/S)
	...
	from_file(S["tgui_input_mode"], pref.tgui_input_mode)
	from_file(S["tgui_large_buttons"], pref.tgui_large_buttons)
	from_file(S["tgui_swapped_buttons"], pref.tgui_swapped_buttons)
...
/datum/category_item/player_setup_item/player_global/ui/save_preferences(savefile/S)
	...
	to_file(S["tgui_input_mode"], pref.tgui_input_mode)
	to_file(S["tgui_large_buttons"], pref.tgui_large_buttons)
	to_file(S["tgui_swapped_buttons"], pref.tgui_swapped_buttons)
