...
/datum/category_item/player_setup_item/vore/resleeve/load_character(var/savefile/S)
	READ_FILE(S["resleeve_lock"], pref.resleeve_lock)
	READ_FILE(S["resleeve_scan"], pref.resleeve_scan)


/datum/category_item/player_setup_item/vore/resleeve/save_character(var/savefile/S)
	WRITE_FILE(S["resleeve_lock"], pref.resleeve_lock)
	WRITE_FILE(S["resleeve_scan"], pref.resleeve_scan)
