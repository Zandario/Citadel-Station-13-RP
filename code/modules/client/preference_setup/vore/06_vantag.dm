...
/datum/category_item/player_setup_item/vore/vantag/load_character(var/savefile/S)
	READ_FILE(S["vantag_volunteer"], pref.vantag_volunteer)
	READ_FILE(S["vantag_preference"], pref.vantag_preference)

/datum/category_item/player_setup_item/vore/vantag/save_character(var/savefile/S)
	WRITE_FILE(S["vantag_volunteer"], pref.vantag_volunteer)
	WRITE_FILE(S["vantag_preference"], pref.vantag_preference)
