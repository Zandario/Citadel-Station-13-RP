...
GLOBAL_LIST_INIT(generic_fishing_rare_list, list(
		/mob/living/simple/animal/passive/fish/solarfish = 0, // was 1, sif meat
		/mob/living/simple/animal/passive/fish/icebass = 0, // was 5, sif meat
		/mob/living/simple/animal/passive/fish/koi = 3,
		/obj/item/reagent_containers/food/snacks/lobster = 2
		))

GLOBAL_LIST_INIT(generic_fishing_uncommon_list, list(
		/mob/living/simple/animal/passive/fish/salmon = 6,
		/mob/living/simple/animal/passive/fish/pike = 10,
		/mob/living/simple/animal/passive/fish/javelin = 0, //was 3, sif meat
		/mob/living/simple/animal/passive/crab/sif = 1
		))

GLOBAL_LIST_INIT(generic_fishing_common_list, list(
		/mob/living/simple/animal/passive/fish/bass = 10,
		/mob/living/simple/animal/passive/fish/trout = 8,
		/mob/living/simple/animal/passive/fish/perch = 6,
		/obj/item/reagent_containers/food/snacks/shrimp = 5,
		/mob/living/simple/animal/passive/fish/murkin = 0, // was 8, sif meat
		/mob/living/simple/animal/passive/fish/rockfish = 0, //was 5, contains sif meat which cannot be used to cook
		/mob/living/simple/animal/passive/crab = 1
		))
...
/obj/random/fishing_junk/item_to_spawn()
	...
	/mob/living/simple/animal/sif/hooligan_crab = 1
	))
