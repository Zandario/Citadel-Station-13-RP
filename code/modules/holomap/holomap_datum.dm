...
/datum/station_holomap/proc/initialize_holomap(var/turf/T, var/isAI = null, var/mob/user = null, var/reinit = FALSE)
	...
	if(!cursor || reinit)
		cursor = image('icons/assets/holomap_markers.dmi', "you")
	if(!legend || reinit)
		legend = image('icons/obj/effect/64x64.dmi', "legend_sc")
...
/datum/station_holomap/proc/initialize_holomap_bogus()
	station_map = image('icons/screen/fullscreen/holomap.dmi', "stationmap")
	legend = image('icons/obj/effect/64x64.dmi', "notfound")
...
// 	legend = image('icons/obj/effect/64x64.dmi', "strategic")
