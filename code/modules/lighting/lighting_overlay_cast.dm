...
/atom/movable/light/proc/cast_light(force_cast)
	...
	if(light_type == LIGHT_TYPE_SOFT_FLICKER)
	...
	if(light_type == LIGHT_TYPE_DIRECTIONAL)
		icon = 'icons/effects/lighting/directional_overlays.dmi'
		light_range = 2.5
	else
	...
	if (!I)
		I = image(icon)
		I.layer = LIGHTING_FALLOFF_LAYER
	...
	// No shadows.
	if(light_range < 2 || light_type == LIGHT_TYPE_DIRECTIONAL)
	...
	for(var/turf/target_turf in affecting_turfs)
		...
		if(!I)
			...
			switch(light_range)
				if(2)
					if(num == 1)
						shadowicon = 'icons/effects/lighting/light_range_2_shadows1.dmi'
					else
						shadowicon = 'icons/effects/lighting/light_range_2_shadows2.dmi'
				if(3)
					if(num == 1)
						shadowicon = 'icons/effects/lighting/light_range_3_shadows1.dmi'
					else
						shadowicon = 'icons/effects/lighting/light_range_3_shadows2.dmi'
				if(4)
					if(num == 1)
						shadowicon = 'icons/effects/lighting/light_range_4_shadows1.dmi'
					else
						shadowicon = 'icons/effects/lighting/light_range_4_shadows2.dmi'
				if(5)
					if(num == 1)
						shadowicon = 'icons/effects/lighting/light_range_5_shadows1.dmi'
					else
						shadowicon = 'icons/effects/lighting/light_range_5_shadows2.dmi'
				if(6)
					if(num == 1)
						shadowicon = 'icons/effects/lighting/light_range_6_shadows1.dmi'
					else
						shadowicon = 'icons/effects/lighting/light_range_6_shadows2.dmi'
				if(7)
					if(num == 1)
						shadowicon = 'icons/effects/lighting/light_range_7_shadows1.dmi'
					else
						shadowicon = 'icons/effects/lighting/light_range_7_shadows2.dmi'

			I = GLOB.lighting_shadow_icon_cache[shadowicon]
			if (!I)
				I = image(shadowicon)
				I.layer = LIGHTING_SHADOW_LAYER
			...
			//TODO: Investigate this. @Zandario
