...
/datum/asset/simple/nanomaps
	...
	assets = list(
		...
		"triumph_nanomap_z2.png"			= 'icons/_nanomaps/triumph_nanomap_z2.png',
		"triumph_nanomap_z3.png"			= 'icons/_nanomaps/triumph_nanomap_z3.png',
		"triumph_nanomap_z4.png"			= 'icons/_nanomaps/triumph_nanomap_z4.png',
		"triumph_nanomap_z5.png"			= 'icons/_nanomaps/triumph_nanomap_z5.png',
	)
