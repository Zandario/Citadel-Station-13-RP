datum/industry
	...
	var/list/title_templates_neutral = list( \
	...
	var/list/title_templates_bad = list( \
	...
	var/list/title_templates_ooc = list( \
	...
	var/list/subtitle_templates = list( \
