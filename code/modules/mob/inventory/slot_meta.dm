...
/datum/inventory_slot_meta/inventory/uniform/rebuild_rendering_caches()
	...
	for(var/bodytype_str in render_rolldown_icons)
		render_rolldown_icons[bodytype_str] = isicon(render_rolldown_icons[bodytype_str])? render_rolldown_icons[bodytype_str] : icon(render_rolldown_icons[bodytype_str])
	...
	for(var/bodytype_str in render_rollsleeve_icons)
		render_rollsleeve_icons[bodytype_str] = isicon(render_rollsleeve_icons[bodytype_str])? render_rollsleeve_icons[bodytype_str] : icon(render_rollsleeve_icons[bodytype_str])
