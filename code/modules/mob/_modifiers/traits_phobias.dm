...
/datum/modifier/trait/phobia/arachnophobe/should_fear()
	...
	for(var/atom/thing in view(5, holder)) // See haemophobia for why this is 5.
		...
		if(istype(thing, /mob/living/simple/animal/giant_spider)) // Actual giant spiders are the scariest of them all.
			var/mob/living/simple/animal/giant_spider/S = thing
...
/datum/modifier/trait/phobia/blennophobe/should_fear()
	...
	for(var/atom/thing in view(5, holder)) // See haemophobia for why this is 5.
		...
		if(istype(thing, /mob/living/simple/slime)) // An actual predatory specimen!
			var/mob/living/simple/slime/S = thing
