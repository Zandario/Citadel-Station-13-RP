...
// MOB HELPERS
// ===========
/mob/living/carbon/human/var/list/datum/medical_effect/GLOB.side_effects = list()
/mob/proc/add_side_effect(name, strength = 0)
/mob/living/carbon/human/add_side_effect(name, strength = 0)
	for(var/datum/medical_effect/M in src.GLOB.side_effects)
		if(M.name == name)
...
/mob/living/carbon/human/proc/handle_medical_GLOB.side_effects()
