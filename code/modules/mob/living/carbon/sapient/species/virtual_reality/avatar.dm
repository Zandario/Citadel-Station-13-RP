...
/datum/species/shapeshifter/promethean/avatar
	...
	valid_transform_species = list(SPECIES_HUMAN, SPECIES_HUMAN_VATBORN, SPECIES_UNATHI, SPECIES_TAJARA, SPECIES_SKRELL, SPECIES_DIONA, SPECIES_TESHARI, SPECIES_VOX, SPECIES_HUMAN_MONKEY, SPECIES_SKELETON)
