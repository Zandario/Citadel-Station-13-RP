...
/mob/living/simple/construct/place_spell_in_hand(var/path)
	if(!path || !ispath(path))
		return 0
...
/mob/living/simple/construct/cultify()
	return

/mob/living/simple/construct/Initialize(mapload)
	. = ..()
...
/mob/living/simple/construct/updateicon()
	cut_overlays()
	..()
	if(do_glow)
		add_glow()

/mob/living/simple/construct/update_icon()
	..()
	if(do_glow)
		add_glow()
...
/mob/living/simple/construct/attack_generic(var/mob/user)
	if(istype(user, /mob/living/simple/construct/builder))
		var/mob/living/simple/construct/builder/B = user
...
/mob/living/simple/construct/examine(mob/user)
	. = ..()
...
/mob/living/simple/construct/Process_Spacemove()
...
/mob/living/simple/construct/armoured/Life(seconds, times_fired)
	weakened = 0
	..()

/mob/living/simple/construct/armoured/bullet_act(var/obj/item/projectile/P)
...
/mob/living/simple/construct/wraith/DoPunch(var/atom/A)
	. = ..()
	if(. && isliving(A))
		var/mob/living/L = A
...
/mob/living/simple/construct/behemoth/bullet_act(var/obj/item/projectile/P)
	var/reflectchance = 80 - round(P.damage/3)
	if(prob(reflectchance))
		visible_message("<span class='danger'>The [P.name] gets reflected by [src]'s shell!</span>", \
						"<span class='userdanger'>The [P.name] gets reflected by [src]'s shell!</span>")
...
////////////////Glow//////////////////
/mob/living/simple/construct/proc/add_glow()
	var/image/eye_glow = image(icon,"glow-[icon_state]")
	eye_glow.plane = ABOVE_LIGHTING_PLANE
	add_overlay(eye_glow)
	set_light(2, -2, l_color = "#FFFFFF")

/mob/living/simple/construct/proc/remove_glow()
	cut_overlays()

////////////////HUD//////////////////////

/mob/living/simple/construct/Life(seconds, times_fired)
	. = ..()
	if(.)
		if(fire)
...
/mob/living/simple/construct/updatehealth() //Special icons.
