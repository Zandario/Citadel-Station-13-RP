...
/mob/living/silicon/robot/attack_ai(mob/user)
	if(shell && Configuration.get_entry(/datum/toml_config_entry/roles/ai/shells) && (!connected_ai || connected_ai == user))
...
/obj/landmark/free_ai_shell/Initialize(mapload)
	if(Configuration.get_entry(/datum/toml_config_entry/roles/ai/shells) && Configuration.get_entry(/datum/toml_config_entry/roles/ai/free_shell))
