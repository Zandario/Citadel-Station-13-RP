...
/mob/living/simple/update_inv_r_hand()
	if(QDESTROYING(src))
		return
...
/mob/living/simple/update_inv_l_hand()
	if(QDESTROYING(src))
		return
...
/mob/living/simple/proc/extra_huds(var/datum/hud/hud,var/icon/ui_style,var/list/hud_elements)
	return

//If they can or cannot use tools/machines/etc
/mob/living/simple/IsAdvancedToolUser()
	return has_hands

/mob/living/simple/proc/IsHumanoidToolUser(var/atom/tool)
	if(!humanoid_hands)
