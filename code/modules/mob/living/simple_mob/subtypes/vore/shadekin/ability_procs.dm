...
/mob/living/simple/shadekin/proc/phase_shift()
...
/mob/living/simple/shadekin/UnarmedAttack()
	if(ability_flags & AB_PHASE_SHIFTED)
		return FALSE //Nope.

	. = ..()

/mob/living/simple/shadekin/can_fall()
	if(ability_flags & AB_PHASE_SHIFTED)
		return FALSE //Nope!

	return ..()

/mob/living/simple/shadekin/zMove(direction)
	if(ability_flags & AB_PHASE_SHIFTED)
...
// Healing others
/mob/living/simple/shadekin/proc/mend_other()
