...
// Activate Noms!
/mob/living/simple/vore/hippo //I don't know why it's in a seperate line but everyone does it so i do it
	vore_active = 1
	vore_capacity = 1
	vore_bump_chance = 15
...
/mob/living/simple/vore/hippo/MouseDroppedOnLegacy(mob/living/M, mob/living/user)
	return
