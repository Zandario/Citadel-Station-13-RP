/mob/living/simple/vore/aggressive/dragon
	name = "red dragon"
...
/mob/living/simple/vore/aggressive/dragon/Process_Spacemove(var/check_drift = 0)
...
/mob/living/simple/vore/aggressive/dragon/virgo3b
	maxHealth = 200
	health = 200
	faction = "virgo3b"
