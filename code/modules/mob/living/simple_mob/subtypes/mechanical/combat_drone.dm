...
/mob/living/simple/mechanical/combat_drone
	name = "combat drone"
...
/mob/living/simple/mechanical/combat_drone/Initialize(mapload)
	ion_trail = new
...
/mob/living/simple/mechanical/combat_drone/Destroy()
	QDEL_NULL(ion_trail)
	QDEL_NULL(shields)
	return ..()

/mob/living/simple/mechanical/combat_drone/death()
	..(null,"suddenly breaks apart.")
	qdel(src)

/mob/living/simple/mechanical/combat_drone/Process_Spacemove(var/check_drift = 0)
	return TRUE
...
/mob/living/simple/mechanical/combat_drone/lesser
...
/mob/living/simple/mechanical/combat_drone/event
