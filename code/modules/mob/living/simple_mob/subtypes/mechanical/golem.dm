...
/mob/living/simple/mechanical/technomancer_golem
...
/mob/living/simple/mechanical/technomancer_golem/Initialize(mapload)
	core = new(src)
	return ..()

/mob/living/simple/mechanical/technomancer_golem/Destroy()
	qdel(core)
	return ..()

/mob/living/simple/mechanical/technomancer_golem/unref_spell()
	active_spell = null
	return ..()

/mob/living/simple/mechanical/technomancer_golem/death()
	..()
...
/mob/living/simple/mechanical/technomancer_golem/place_spell_in_hand(var/path)
	if(!path || !ispath(path))
		return FALSE
	if(active_spell)
		qdel(active_spell)
...
/mob/living/simple/mechanical/technomancer_golem/verb/test_giving_spells()
...
/mob/living/simple/mechanical/technomancer_golem/get_technomancer_core()
	return core

/mob/living/simple/mechanical/technomancer_golem/can_special_attack(atom/A)
	if(active_spell) // Don't bother checking everything else if no spell is ready.
		return ..()
	return FALSE

/mob/living/simple/mechanical/technomancer_golem/should_special_attack(atom/A)
	return instability < 50 // Don't kill ourselves by casting everything.


/mob/living/simple/mechanical/technomancer_golem/do_special_attack(atom/A)
...
/mob/living/simple/mechanical/technomancer_golem/melee_pre_animation(atom/A)
...
/mob/living/simple/mechanical/technomancer_golem/melee_post_animation(atom/A)
...
/mob/living/simple/mechanical/technomancer_golem/ranged_pre_animation(atom/A)
	flick("golem_pre_ranged", src)
	icon_living = "golem_pre_ranged"
	icon_state = "golem_pre_ranged"
	setClickCooldown(5)

/mob/living/simple/mechanical/technomancer_golem/ranged_post_animation(atom/A)
	flick("golem_post_ranged", src)
	icon_living = "golem"
	icon_state = "golem"
	setClickCooldown(5)

/mob/living/simple/mechanical/technomancer_golem/special_pre_animation(atom/A)
	casting = TRUE
	ranged_pre_animation(A) // Both have the same animation.

/mob/living/simple/mechanical/technomancer_golem/special_post_animation(atom/A)
	casting = FALSE
