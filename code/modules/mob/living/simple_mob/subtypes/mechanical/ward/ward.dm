...
/mob/living/simple/mechanical/ward
	name = "ward"
...
/mob/living/simple/mechanical/ward/death()
	..(null,"is smashed into pieces!")
	qdel(src)

/mob/living/simple/mechanical/ward/Destroy()
	owner = null
	return ..()

/mob/living/simple/mechanical/ward/IIsAlly(mob/living/L)
	if(owner == L)
		return TRUE
	return ..()
