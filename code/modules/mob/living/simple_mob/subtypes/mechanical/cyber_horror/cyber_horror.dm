...
/mob/living/simple/mechanical/cyber_horror
	name = "Cyber horror"
...
/mob/living/simple/mechanical/cyber_horror/plasma_cyber_horror
	name = "Nanite husk"
...
/mob/living/simple/mechanical/cyber_horror/plasma_cyber_horror/apply_melee_effects(var/atom/A)
	if(isliving(A))
		var/mob/living/L = A
		if(L.reagents)
...
/mob/living/simple/mechanical/cyber_horror/plasma_cyber_horror/proc/inject_poison(mob/living/L, target_zone)
	if(prob(poison_chance))
		to_chat(L, "<span class='warning'>You feel nanites digging into your skin!</span>")
		L.reagents.add_reagent(poison_type, poison_per_bite)
 // Mech Shredder
/mob/living/simple/mechanical/cyber_horror/ling_cyber_horror
...
/mob/living/simple/mechanical/cyber_horror/ling_cyber_horror/apply_bonus_melee_damage(atom/A, damage_amount)
	if(isliving(A))
		var/mob/living/L = A
...
/mob/living/simple/mechanical/cyber_horror/ling_cyber_horror/do_special_attack(atom/A)
	set waitfor = FALSE
	set_AI_busy(TRUE)
...
/mob/living/simple/mechanical/cyber_horror/vox
	name = "Vox shambles"
 ...
 // Hit and run mob
/mob/living/simple/mechanical/cyber_horror/tajaran
...
/mob/living/simple/mechanical/cyber_horror/tajaran/proc/stealth()
	if(stealthed)
		return
	animate(src, alpha = stealthed_alpha, time = 1 SECOND)
	stealthed = TRUE

/mob/living/simple/mechanical/cyber_horror/tajaran/proc/unstealth()
...
/mob/living/simple/mechanical/cyber_horror/tajaran/proc/can_stealth()
	if(stat)
		return FALSE
...
/mob/living/simple/mechanical/cyber_horror/tajaran/break_cloak()
	unstealth()


/mob/living/simple/mechanical/cyber_horror/tajaran/is_cloaked()
	return stealthed


// Cloaks the tajaran automatically, if possible.
/mob/living/simple/mechanical/cyber_horror/tajaran/handle_special()
	if(!stealthed && can_stealth())
		stealth()


// Applies bonus base damage if stealthed.
/mob/living/simple/mechanical/cyber_horror/tajaran/apply_bonus_melee_damage(atom/A, damage_amount)
	if(stealthed)
		return damage_amount + stealthed_bonus_damage
	return ..()

// Applies stun, then unstealths.
/mob/living/simple/mechanical/cyber_horror/tajaran/apply_melee_effects(atom/A)
	if(stealthed)
		if(isliving(A))
			var/mob/living/L = A
...
/mob/living/simple/mechanical/cyber_horror/tajaran/bullet_act(obj/item/projectile/P)
	. = ..()
	break_cloak()

/mob/living/simple/mechanical/cyber_horror/tajaran/hit_with_weapon(obj/item/O, mob/living/user, effective_force, hit_zone)
	. = ..()
	break_cloak()

//Arcing Ranged Mob
/mob/living/simple/mechanical/cyber_horror/grey
...
//Direct Ranged Mob
/mob/living/simple/mechanical/cyber_horror/corgi
...
//Cats and mayhem
/mob/living/simple/mechanical/cyber_horror/cat_cyber_horror
	name = "Twisted cat"
...
/mob/living/simple/mechanical/cyber_horror/cat_cyber_horror/apply_melee_effects(var/atom/A)
	if(isliving(A))
		var/mob/living/L = A
		if(L.reagents)
			var/target_zone = pick(BP_TORSO,BP_TORSO,BP_TORSO,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_HEAD)
 ...
 // Does actual poison injection, after all checks passed.
/mob/living/simple/mechanical/cyber_horror/cat_cyber_horror/proc/inject_poison(mob/living/L, target_zone)
	if(prob(poison_chance))
...
/mob/living/simple/mechanical/cyber_horror/priest
...
/mob/living/simple/mechanical/cyber_horror/priest/apply_melee_effects(var/atom/A)
	if(isliving(A))
		var/mob/living/L = A
		if(L.reagents)
			var/target_zone = pick(BP_TORSO,BP_TORSO,BP_TORSO,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_HEAD)
...
/mob/living/simple/mechanical/cyber_horror/priest/proc/inject_poison(mob/living/L, target_zone)
	if(prob(poison_chance))
		to_chat(L, "<span class='warning'>You feel nanites digging into your skin!</span>")
		L.reagents.add_reagent(poison_type, poison_per_bite)

/mob/living/simple/mechanical/cyber_horror/priest/should_special_attack(atom/A)
...
/mob/living/simple/mechanical/cyber_horror/priest/do_special_attack(atom/target)
	set waitfor = FALSE
...
/mob/living/simple/mechanical/cyber_horror/surt
...
// Fragile but dangerous
/mob/living/simple/mechanical/cyber_horror/plasma_cyber_horror/surt
...
// Mech Shredder
/mob/living/simple/mechanical/cyber_horror/ling_cyber_horror/surt
...
//Slightly more durable fodder
/mob/living/simple/mechanical/cyber_horror/vox/surt
 ...
 // Hit and run mob
/mob/living/simple/mechanical/cyber_horror/tajaran/surt
...
//Arcing Ranged Mob
/mob/living/simple/mechanical/cyber_horror/grey/surt
	name = "exhumed deacon"
...
//Direct Ranged Mob
/mob/living/simple/mechanical/cyber_horror/corgi/surt
...
//Cats and mayhem
/mob/living/simple/mechanical/cyber_horror/cat_cyber_horror/surt
...
/mob/living/simple/mechanical/cyber_horror/priest/surt
...
/mob/living/simple/mechanical/cyber_horror/priest/thechanged
