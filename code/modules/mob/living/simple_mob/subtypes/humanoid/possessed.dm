...
/mob/living/simple_mob/humanoid/possessed/Destroy()
	...
	var/random_line = pick(
		"The horrid screech of metal grating metal cuts through the air as the suit's interlocking joints grind and fold inwards upon itself. A putrid wash of decayed flesh spills forwards, staining the ground dark with the contents of the collapsing RIG's long expired pilot.",
	...
	visible_message(SPAN_CRITICAL(random_line))
