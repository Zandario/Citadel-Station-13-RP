...
//		Knife Priate
///////////////////////////////
/mob/living/simple/humanoid/pirate
	name = "Pirate"
...
/mob/living/simple/humanoid/pirate/las
	name = "Pirate Duelist"
...
//Armored Variant
/mob/living/simple/humanoid/pirate/las/armored
...
/mob/living/simple/humanoid/pirate/shield/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(O.force)
		if(prob(15))
...
//Armored Variant
/mob/living/simple/humanoid/pirate/ranged/shotgun/armored
...
//Armored Variant
/mob/living/simple/humanoid/pirate/ranged/handcannon/armored
...
//		First Mate
///////////////////////////////
/mob/living/simple/humanoid/pirate/mate
	name = "First Mate"
...
/mob/living/simple/humanoid/pirate/mate/ranged/bosun /// Special Mech Pilot Pirate
	name = "Bosun"
...
//		Pirate Captain
///////////////////////////////
/mob/living/simple/humanoid/pirate/captain
	name = "Pirate Captain"
...
/mob/living/simple/humanoid/pirate/captain/Initialize(mapload)
	shields = new /obj/item/shield_projector/rectangle/automatic/drone(src)
	return ..()

/mob/living/simple/humanoid/pirate/captain/Process_Spacemove(var/check_drift = 0)
	return TRUE
...
//Machete Pirate
/mob/living/simple/humanoid/pirate/machete/old
	icon_state = "old-piratemelee-machete"
	icon_living = "old-piratemelee-machete"
	icon_dead = "old-piratemelee_dead"

//Armored Variant
/mob/living/simple/humanoid/pirate/machete/armored/old
...
//E-Sword Pirate
/mob/living/simple/humanoid/pirate/las/old
...
//Armored Variant
/mob/living/simple/humanoid/pirate/las/armored/old
...
//Shield Pirate
/mob/living/simple/humanoid/pirate/shield/old
	icon_state = "old-piratemelee-shield"
	icon_living = "old-piratemelee-shield"

// Armored Variant
/mob/living/simple/humanoid/pirate/shield/armored/old
	icon_state = "old-piratemelee-shield-armor"
	icon_living = "old-piratemelee-shield-armor"
	loot_list = list(/obj/item/material/knife/tacknife = 100, /obj/item/clothing/suit/armor/material/makeshift = 100)

//Shield Machete Pirate
/mob/living/simple/humanoid/pirate/shield/machete/old
...
// Armored Variant
/mob/living/simple/humanoid/pirate/shield/machete/armored/old
	icon_state = "old-piratemelee-shield-machete-armor"
	icon_living = "old-piratemelee-shield-machete-armor"
	loot_list = list(/obj/item/material/knife/machete = 100, /obj/item/clothing/suit/armor/material/makeshift = 100)

//Pirate Pistolier
/mob/living/simple/humanoid/pirate/ranged/old
...
//Armored Variant
/mob/living/simple/humanoid/pirate/ranged/armored/old
