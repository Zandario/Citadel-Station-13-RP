/mob/living/simple/animal/borer/verb/release_host()
...
/mob/living/simple/animal/borer/verb/infest()
	set category = "Abilities"
	set name = "Infest"
	...
	var/mob/living/complex/M = input(src,"Who do you wish to infest?") in null|choices
...
/*
/mob/living/simple/animal/borer/verb/devour_brain()
	set category = "Abilities"
...
/mob/living/simple/animal/borer/proc/replace_brain()
	...
	if(host.stat == 2)
		add_verb(H, /mob/living/complex/human/proc/jumpstart)

	add_verb(H, /mob/living/complex/human/proc/psychic_whisper)
	add_verb(H, /mob/living/complex/human/proc/tackle)
	add_verb(H, /mob/living/complex/proc/spawn_larvae)
...
/mob/living/simple/animal/borer/verb/secrete_chemicals()
	set category = "Abilities"
...
/mob/living/simple/animal/borer/verb/dominate_victim()
	set category = "Abilities"
	...
	var/list/choices = list()
	for(var/mob/living/complex/C in view(3,src))
		if(C.stat != 2)
			choices += C
	...
	var/mob/living/complex/M = input(src,"Who do you wish to dominate?") in null|choices
...
/mob/living/simple/animal/borer/verb/bond_brain()
	set category = "Abilities"
	...
	spawn(100+(host.brainloss*5))
		...
		if(!host || !src || controlling)
			...
			add_verb(host, /mob/living/complex/proc/release_control)
			add_verb(host, /mob/living/complex/proc/punish_host)
			add_verb(host, /mob/living/complex/proc/spawn_larvae)

			return

/mob/living/complex/human/proc/jumpstart()
	set category = "Abilities"
	...
	remove_verb(src, /mob/living/complex/human/proc/jumpstart)
