...
/mob/living/simple/animal/borer
	name = "cortical borer"
	...
	var/mob/living/complex/human/host = null		// The humanoid host for the brain worm.
...
/mob/living/simple/animal/borer/roundstart
	roundstart = TRUE

/mob/living/simple/animal/borer/Login()
	..()
	if(mind)
		borers.add_antagonist(mind)

/mob/living/simple/animal/borer/Initialize(mapload)
...
/mob/living/simple/animal/borer/handle_special()
...
/mob/living/simple/animal/borer/statpanel_data(client/C)
	. = ..()
	if(C.statpanel_tab("Status"))
		STATPANEL_DATA_ENTRY("Chemicals", "[chemicals]")

/mob/living/simple/animal/borer/proc/detatch()
	if(!host || !controlling)
		return

	if(istype(host, /mob/living/complex/human))
	...
	remove_verb(host, /mob/living/complex/proc/release_control)
	remove_verb(host, /mob/living/complex/proc/punish_host)
	remove_verb(host, /mob/living/complex/proc/spawn_larvae)
...
/mob/living/simple/animal/borer/proc/leave_host()
	if(!host)
		return
...
/mob/living/simple/animal/borer/proc/request_player()
...
/mob/living/simple/animal/borer/proc/transfer_personality(mob/candidate)
...
/mob/living/simple/animal/borer/cannot_use_vents()
	return

// This is awful but its literally say code.
/mob/living/simple/animal/borer/say(var/message, var/datum/language/speaking = null, var/verb="says", var/alt_name="", var/whispering = 0)
