...
/mob/living/simple/animal/giant_spider/lurker
...
/mob/living/simple/animal/giant_spider/lurker/proc/stealth()
	if(stealthed)
		return
...
/mob/living/simple/animal/giant_spider/lurker/proc/unstealth()
...
/mob/living/simple/animal/giant_spider/lurker/proc/can_stealth()
	if(stat)
		return FALSE
...
/mob/living/simple/animal/giant_spider/lurker/break_cloak()
	unstealth()


/mob/living/simple/animal/giant_spider/lurker/is_cloaked()
	return stealthed


// Cloaks the spider automatically, if possible.
/mob/living/simple/animal/giant_spider/lurker/handle_special()
	if(!stealthed && can_stealth())
		stealth()


// Applies bonus base damage if stealthed.
/mob/living/simple/animal/giant_spider/lurker/apply_bonus_melee_damage(atom/A, damage_amount)
	if(stealthed)
		return damage_amount + stealthed_bonus_damage
	return ..()

// Applies stun, then unstealths.
/mob/living/simple/animal/giant_spider/lurker/apply_melee_effects(atom/A)
	if(stealthed)
		if(isliving(A))
			var/mob/living/L = A
...
/mob/living/simple/animal/giant_spider/lurker/bullet_act(obj/item/projectile/P)
	. = ..()
	break_cloak()

/mob/living/simple/animal/giant_spider/lurker/hit_with_weapon(obj/item/O, mob/living/user, effective_force, hit_zone)
	. = ..()
	break_cloak()
