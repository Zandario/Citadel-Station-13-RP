...
/mob/living/simple/animal/giant_spider
	name = "giant spider"
...
/mob/living/simple/animal/giant_spider/apply_melee_effects(var/atom/A)
	if(isliving(A))
		var/mob/living/L = A
		if(L.reagents)
...
/mob/living/simple/animal/giant_spider/proc/inject_poison(mob/living/L, target_zone)
	if(prob(poison_chance))
		L.custom_pain(SPAN_WARNING("You feel a tiny prick."), 1, TRUE)
		L.reagents.add_reagent(poison_type, poison_per_bite)

/mob/living/simple/animal/giant_spider/proc/make_spiderling()
