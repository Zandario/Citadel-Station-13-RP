...
/mob/living/simple/animal/passive/fox/init_vore()
	..()
...
/mob/living/simple/animal/passive/fox/apply_melee_effects(var/atom/A)
	if(ismouse(A))
...
/mob/living/simple/animal/passive/fox/OnMouseDropLegacy(atom/over_object)
...
/mob/living/simple/animal/passive/fox/get_scooped(var/mob/living/complex/grabber)
	if (stat >= DEAD)
		return //since the holder icon looks like a living cat
	..()

/mob/living/simple/animal/passive/fox/renault/IIsAlly(mob/living/L)
...
/mob/living/simple/animal/passive/fox/renault/verb/become_friends()
...
//Basic friend AI
/mob/living/simple/animal/passive/fox/fluff
	var/mob/living/complex/human/friend
	var/befriend_job = null

/mob/living/simple/animal/passive/fox/fluff/Life(seconds, times_fired)
	. = ..()
	if(!. || !friend) return
...
/mob/living/simple/animal/passive/fox/fluff/verb/friend()
	set name = "Become Friends"
	set category = "IC"
	set src in view(1)
...
//Captain fox
/mob/living/simple/animal/passive/fox/renault
	name = "Renault"
...
/mob/living/simple/animal/passive/fox/renault/init_vore()
	..()
	var/obj/belly/B = vore_selected
	B.name = "Stomach"
...
/mob/living/simple/animal/passive/fox/syndicate
	name = "syndi-fox"
