...
/mob/living/simple/animal/passive/bird/parrot
	name = "parrot"
...
/mob/living/simple/animal/passive/bird/parrot/ISay(message)
...
/mob/living/simple/animal/passive/bird/parrot/handle_message_mode(message_mode, message, verb, speaking, used_radios, alt_name)
	..()
	if(message_mode)
...
/mob/living/simple/animal/passive/bird/parrot/attackby(obj/item/I, mob/user)
...
/mob/living/simple/animal/passive/bird/parrot/attack_hand(mob/living/L)
...
/mob/living/simple/animal/passive/bird/parrot/proc/give_headset(obj/item/radio/headset/new_headset, mob/living/user)
...
/mob/living/simple/animal/passive/bird/parrot/proc/remove_headset(mob/living/user)
	if(!my_headset)
...
/mob/living/simple/animal/passive/bird/parrot/examine(mob/user)
	. = ..()
	if(my_headset)
		. += "It is wearing \a [my_headset]."

/mob/living/simple/animal/passive/bird/parrot/Initialize(mapload)
	if(my_headset)
...
// Best Bird
/mob/living/simple/animal/passive/bird/parrot/polly
	name = "Polly"
...
/mob/living/simple/animal/passive/bird/parrot/polly/ultimate
	my_headset = /obj/item/radio/headset/omni

/mob/living/simple/animal/passive/bird/parrot/kea
	name = "kea"
...
/mob/living/simple/animal/passive/bird/parrot/eclectus
	name = "eclectus"
...
/mob/living/simple/animal/passive/bird/parrot/eclectus/Initialize(mapload)
...
/mob/living/simple/animal/passive/bird/parrot/grey_parrot
	name = "grey parrot"
...
/mob/living/simple/animal/passive/bird/parrot/black_headed_caique
...
/mob/living/simple/animal/passive/bird/parrot/white_caique
...
/mob/living/simple/animal/passive/bird/parrot/budgerigar
	name = "budgerigar"
...
/mob/living/simple/animal/passive/bird/parrot/budgerigar/blue
	icon_state = "bbudge"
...
/mob/living/simple/animal/passive/bird/parrot/budgerigar/bluegreen
	icon_state = "bgbudge"
...
/mob/living/simple/animal/passive/bird/parrot/cockatiel
	name = "cockatiel"
...
/mob/living/simple/animal/passive/bird/parrot/cockatiel/white
	icon_state = "wtiel"
	icon_rest = "wtiel-held"
	icon_dead = "wtiel-dead"

/mob/living/simple/animal/passive/bird/parrot/cockatiel/yellowish
	icon_state = "luttiel"
	icon_rest = "luttiel-held"
	icon_dead = "luttiel-dead"

/mob/living/simple/animal/passive/bird/parrot/cockatiel/grey
...
/mob/living/simple/animal/passive/bird/parrot/sulphur_cockatoo
...
/mob/living/simple/animal/passive/bird/parrot/white_cockatoo
	name = "white cockatoo"
...
/mob/living/simple/animal/passive/bird/parrot/pink_cockatoo
	name = "pink cockatoo"
