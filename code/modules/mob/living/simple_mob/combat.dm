// Does a melee attack.
/mob/living/simple/proc/attack_target(atom/A)
...
/mob/living/simple/proc/do_attack(atom/A, turf/T)
	face_atom(A)
	var/missed = FALSE
...
/mob/living/simple/proc/apply_attack(atom/A, damage_to_do)
...
/mob/living/simple/proc/apply_melee_effects(atom/A)
	return
...
/mob/living/simple/proc/apply_bonus_melee_damage(atom/A, damage_amount)
	return damage_amount

//The actual top-level ranged attack proc
/mob/living/simple/proc/shoot_target(atom/A)
	set waitfor = FALSE
	setClickCooldown(get_attack_speed())
...
/mob/living/simple/proc/shoot(atom/A)
	if(A == get_turf(src))
		return
...
/mob/living/simple/proc/try_reload()
	set waitfor = FALSE
	set_AI_busy(TRUE)
...
/mob/living/simple/proc/calculate_dispersion()
...
/mob/living/simple/proc/calculate_accuracy()
...
/mob/living/simple/proc/can_special_attack(atom/A)
	// Validity check.
	if(!istype(A))
		return FALSE
...
/mob/living/simple/proc/should_special_attack(atom/A)
	return TRUE
...
/mob/living/simple/proc/special_attack_target(atom/A)
	face_atom(A)
...
/mob/living/simple/proc/do_special_attack(atom/A)
	return FALSE
...
/mob/living/simple/proc/handle_attack_delay(atom/A, delay_amount)
	set_AI_busy(TRUE)
...
/mob/living/simple/proc/melee_pre_animation(atom/A)
	do_windup_animation(A, melee_attack_delay)

/mob/living/simple/proc/melee_post_animation(atom/A)

/mob/living/simple/proc/ranged_pre_animation(atom/A)
	do_windup_animation(A, ranged_attack_delay) // Semi-placeholder.

/mob/living/simple/proc/ranged_post_animation(atom/A)

/mob/living/simple/proc/special_pre_animation(atom/A)
	do_windup_animation(A, special_attack_delay) // Semi-placeholder.

/mob/living/simple/proc/special_post_animation(atom/A)
