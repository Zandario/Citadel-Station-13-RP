 ...
 */
/mob/living/complex/proc/attempt_cpr_interaction(mob/user)
	. = TRUE
...
/mob/living/complex/proc/attempt_cpr(atom/actor, delay_mod = 1)
...
/mob/living/complex/proc/__cpr_ventilation_end()
	REMOVE_TRAIT(src, TRAIT_MECHANICAL_VENTILATION, CPR_TRAIT)

/mob/living/complex/proc/__cpr_organ_stasis_end()
	REMOVE_TRAIT(src, TRAIT_PRESERVE_ALL_ORGANS, CPR_TRAIT)

/mob/living/complex/proc/__cpr_off_cooldown()
	REMOVE_TRAIT(src, TRAIT_CPR_COOLDOWN, CPR_TRAIT)

/mob/living/complex/proc/__cpr_circulation_end()
	REMOVE_TRAIT(src, TRAIT_MECHANICAL_CIRCULATION, CPR_TRAIT)

/mob/living/complex/proc/__cpr_forced_metabolism(strength = 1)
	if(stat != DEAD)
...
/mob/living/complex/proc/cpr_act(atom/actor)
