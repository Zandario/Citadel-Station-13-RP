/mob/living/complex/proc/ingest(datum/reagents/from, datum/reagents/target, amount = 1, multiplier = 1, copy = 0) //we kind of 'sneak' a proc in here for ingesting stuff so we can play with it.
...
*/
/datum/reagents/proc/generate_taste_message(mob/living/complex/taster = null)
	var/minimum_percent = 15
	if(ishuman(taster))
		var/mob/living/complex/human/H = taster
