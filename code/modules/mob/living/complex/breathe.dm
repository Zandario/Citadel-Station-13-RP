...
/mob/living/complex/handle_breathing()
...
/mob/living/complex/proc/breathe()
...
/mob/living/complex/proc/get_breath_from_internal(var/volume_needed=BREATH_VOLUME) //hopefully this will allow overrides to specify a different default volume without breaking any cases where volume is passed in.
	if(internal)
...
/mob/living/complex/proc/get_breath_from_environment(var/volume_needed=BREATH_VOLUME)
...
/mob/living/complex/proc/handle_chemical_smoke(var/datum/gas_mixture/environment)
...
/mob/living/complex/proc/handle_breath(datum/gas_mixture/breath)
	return

/mob/living/complex/proc/handle_post_breath(datum/gas_mixture/breath)
	if(breath)
