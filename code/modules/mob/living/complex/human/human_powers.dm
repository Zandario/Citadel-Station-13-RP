...
/mob/living/complex/human/proc/tackle()
...
/mob/living/complex/human/proc/regurgitate()
...
/mob/living/complex/human/proc/psychic_whisper(mob/M as mob in oview())
...
/mob/living/complex/human/proc/diona_split_into_nymphs(var/number_of_resulting_nymphs)
	var/turf/T = get_turf(src)

	var/mob/living/complex/alien/diona/S = new(T)
	S.setDir(dir)
	...
	for(var/mob/living/complex/alien/diona/D in src)
		nymphs++
		D.forceMove(T)
	...
	if(nymphs < number_of_resulting_nymphs)
		for(var/i in nymphs to (number_of_resulting_nymphs - 1))
			var/mob/M = new /mob/living/complex/alien/diona(T)
	...
	if(Chest.robotic >= 2)
		...
		remove_verb(src, /mob/living/complex/human/proc/diona_split_nymph)
		remove_verb(src, /mob/living/complex/human/proc/regenerate)
...
/mob/living/complex/human/proc/setmonitor_state()
...
/mob/living/complex/human/proc/get_charge(var/mob/living/complex/human/H)
	return H.nutrition

/mob/living/complex/human/proc/spend_charge(var/spent, var/mob/living/complex/human/H)
	H.nutrition = H.nutrition - spent

/mob/living/complex/human/verb/toggle_eyes_layer()
...
/mob/living/complex/human/proc/shadekin_get_energy()
...
/mob/living/complex/human/proc/shadekin_get_max_energy()
	var/datum/species/shadekin/sk = species
	var/datum/species/crew_shadekin/besk = species
...
/mob/living/complex/human/proc/shadekin_set_energy(new_energy)
	var/datum/species/shadekin/sk = species
	var/datum/species/crew_shadekin/besk = species
...
/mob/living/complex/human/proc/shadekin_set_max_energy(new_max_energy)
	var/datum/species/shadekin/sk = species
	var/datum/species/crew_shadekin/besk = species
...
/mob/living/complex/human/proc/shadekin_adjust_energy(amount)
	var/datum/species/shadekin/sk = species
	var/datum/species/crew_shadekin/besk = species
