...
/mob/living/complex/human/var/datum/reagents/vessel // Container for blood and BLOOD ONLY. Do not transfer other chems here.
/mob/living/complex/human/var/var/pale = 0          // Should affect how mob sprite is drawn, but currently doesn't.

//Initializes blood vessels
/mob/living/complex/human/proc/make_blood()
...
//Resets blood data
/mob/living/complex/human/proc/fixblood()
...
/mob/living/complex/human/handle_blood()
	if(inStasisNow())
		return
				...
				if(W.bleeding())
					...
					if(temp.applied_pressure)
						if(ishuman(temp.applied_pressure))
							var/mob/living/complex/human/H = temp.applied_pressure
...
/mob/living/complex/human/proc/drip(var/amt)
	if(remove_blood(amt))
		blood_splatter(src,src)

/mob/living/complex/human/proc/remove_blood(var/amt)
...
/mob/living/complex/proc/take_blood(obj/item/reagent_containers/container, var/amount)
...
/mob/living/complex/human/take_blood(obj/item/reagent_containers/container, var/amount)
...
/mob/living/complex/proc/inject_blood(var/datum/reagent/blood/injected, var/amount)
...
/mob/living/complex/human/inject_blood(var/datum/reagent/blood/injected, var/amount)
...
/mob/living/complex/proc/get_blood(datum/reagents/container)
...
/proc/blood_splatter(target, datum/reagent/blood/source, large)
	...
	if(istype(source,/mob/living/complex/human))
		var/mob/living/complex/human/M = source
