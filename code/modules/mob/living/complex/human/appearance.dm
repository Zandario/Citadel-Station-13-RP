/mob/living/complex/human/proc/change_appearance(var/flags = APPEARANCE_ALL_HAIR, var/location = src, var/mob/user = src, var/check_species_whitelist = 1, var/list/species_whitelist = list(), var/list/species_blacklist = list(), var/datum/topic_state/state = default_state)
...
/mob/living/complex/human/proc/change_species(var/new_species)
	if(!new_species)
		return
...
/mob/living/complex/human/proc/change_gender(var/gender)
...
/mob/living/complex/human/proc/change_gender_identity(var/identifying_gender)
...
/mob/living/complex/human/proc/change_hair(var/hair_style)
	if(!hair_style)
		return
...
/mob/living/complex/human/proc/change_hair_gradient(var/hair_gradient)
	if(!hair_gradient)
		return
...
/mob/living/complex/human/proc/change_wing_gradient(var/wing_gradient)
	if(!wing_gradient)
		return
...
/mob/living/complex/human/proc/change_facial_hair(var/facial_hair_style)
...
/mob/living/complex/human/proc/reset_hair()
...
/mob/living/complex/human/proc/change_eye_color(var/red, var/green, var/blue)
...
/mob/living/complex/human/proc/change_hair_color(var/red, var/green, var/blue)
...
/mob/living/complex/human/proc/change_grad_color(var/red, var/green, var/blue)
...
/mob/living/complex/human/proc/change_facial_hair_color(var/red, var/green, var/blue)
...
/mob/living/complex/human/proc/change_skin_color(var/red, var/green, var/blue)
...
/mob/living/complex/human/proc/change_skin_tone(var/tone)
...
/mob/living/complex/human/proc/update_dna()
	check_dna()
	dna.ready_dna(src)

/mob/living/complex/human/proc/generate_valid_species(var/check_whitelist = 1, var/list/whitelist = list(), var/list/blacklist = list())
...
/mob/living/complex/human/proc/generate_valid_hairstyles(var/check_gender = 1)
...
/mob/living/complex/human/proc/generate_valid_facial_hairstyles()
...
/mob/living/complex/human/proc/force_update_limbs()
