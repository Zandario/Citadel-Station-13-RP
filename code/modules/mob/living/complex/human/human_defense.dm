...
/mob/living/complex/human/bullet_act(var/obj/item/projectile/P, var/def_zone)
...
/mob/living/complex/human/stun_effect_act(var/stun_amount, var/agony_amount, var/def_zone)
...
/mob/living/complex/human/run_mob_armor(var/def_zone, var/type)
	var/armorval = 0
	var/total = 0
...
/mob/living/complex/human/run_mob_soak(var/def_zone, var/type)
	var/soakval = 0
	var/total = 0
...
/mob/living/complex/human/proc/get_siemens_coefficient_organ(var/obj/item/organ/external/def_zone)
	if (!def_zone)
		return 1.0
...
/mob/living/complex/human/proc/get_siemens_coefficient_average()
	var/siemens_value = 0
	var/total = 0
	for(var/organ_name in organs_by_name)
		if(organ_name in organ_rel_size)
...
/mob/living/complex/human/get_shock_protection()
	return clamp( 1-get_siemens_coefficient_average(), 0,  1)

// Returns a list of clothing that is currently covering def_zone.
/mob/living/complex/human/proc/get_clothing_list_organ(var/obj/item/organ/external/def_zone, var/type)
...
/mob/living/complex/human/proc/getarmor_organ(var/obj/item/organ/external/def_zone, var/type)
	if(!type || !def_zone)
		return 0
	var/protection = 0
...
/mob/living/complex/human/proc/getsoak_organ(var/obj/item/organ/external/def_zone, var/type)
	if(!type || !def_zone)
		return 0
	var/soaked = 0
	var/list/protective_gear = def_zone.get_covering_clothing()
...
/mob/living/complex/human/proc/check_head_coverage()
...
/mob/living/complex/human/proc/check_mouth_coverage()
	var/obj/item/organ/external/H = organs_by_name[BP_HEAD]
...
/mob/living/complex/human/proc/check_mouth_coverage_survival()
	var/obj/item/organ/external/H = organs_by_name[BP_HEAD]
	var/list/protective_gear = H.get_covering_clothing(FACE)
	for(var/obj/item/gear in protective_gear)
...
/mob/living/complex/human/proc/check_shields(var/damage = 0, var/atom/damage_source = null, var/mob/attacker = null, var/def_zone = null, var/attack_text = "the attack")
...
/mob/living/complex/human/resolve_item_attack(obj/item/I, mob/living/user, var/target_zone)
...
/mob/living/complex/human/hit_with_weapon(obj/item/I, mob/living/user, var/effective_force, var/hit_zone)
	var/obj/item/organ/external/affecting = get_organ(hit_zone)
	if(!affecting)
...
/mob/living/complex/human/standard_weapon_hit_effects(obj/item/I, mob/living/user, var/effective_force, var/blocked, var/soaked, var/hit_zone)
	var/obj/item/organ/external/affecting = get_organ(hit_zone)
	if(!affecting)
		return 0
...
/mob/living/complex/human/proc/attack_joint(var/obj/item/organ/external/organ, var/obj/item/W, var/effective_force, var/dislocate_mult, var/blocked, var/soaked)
...
/mob/living/complex/human/emag_act(var/remaining_charges, mob/user, var/emag_source)
...
/mob/living/complex/human/throw_impacted(atom/movable/AM, datum/thrownthing/TT)
...
/mob/living/complex/human/proc/can_catch(var/obj/O)
...
/mob/living/complex/human/embed(var/obj/O, var/def_zone=null)
	if(!def_zone) ..()
...
/mob/living/complex/human/proc/bloody_hands(var/mob/living/source, var/amount = 2)
	if (gloves)
...
/mob/living/complex/human/proc/bloody_body(var/mob/living/source)
	if(wear_suit)
...
/mob/living/complex/human/proc/handle_suit_punctures(var/damtype, var/damage, var/def_zone)
...
/mob/living/complex/human/reagent_permeability()
	var/perm = 0
...
/mob/living/complex/human/get_water_protection()
...
/mob/living/complex/human/shank_attack(obj/item/W, obj/item/grab/G, mob/user, hit_zone)
