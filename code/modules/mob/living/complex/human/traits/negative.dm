...
/datum/trait/negative/endurance_low/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/negative/endurance_very_low/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.setMaxHealth(S.total_health)
...
/datum/trait/negative/hollow/apply(var/datum/species/S,var/mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/negative/hollow_plus/apply(var/datum/species/S,var/mob/living/complex/human/H)
	..(S,H)
	for(var/obj/item/organ/external/O in H.organs)
...
/datum/trait/negative/colorblind/mono/apply(var/datum/species/S,var/mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/negative/colorblind/para_vulp/apply(var/datum/species/S,var/mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/negative/colorblind/para_taj/apply(var/datum/species/S,var/mob/living/complex/human/H)
	..(S,H)
