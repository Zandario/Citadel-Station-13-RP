...
/datum/trait/neutral/bloodsucker/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	add_verb(H, /mob/living/complex/human/proc/bloodsuck)
...
/datum/trait/neutral/succubus_drain/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	add_verb(H, /mob/living/complex/human/proc/succubus_drain)
	add_verb(H, /mob/living/complex/human/proc/succubus_drain_finalize)
	add_verb(H, /mob/living/complex/human/proc/succubus_drain_lethal)
...
/datum/trait/neutral/vampire/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	add_verb(H, /mob/living/complex/human/proc/bloodsuck)
	add_verb(H, /mob/living/complex/human/proc/lick_wounds)
...
/datum/trait/neutral/hard_vore/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/neutral/trashcan/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/neutral/glowing_body/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/neutral/taller/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/tall/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/short/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/shorter/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/fat/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/obese/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/thin/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/thinner/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	H.update_transform()
...
/datum/trait/neutral/antiseptic_saliva/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
	add_verb(H, /mob/living/complex/human/proc/lick_wounds)
...
/datum/trait/neutral/size_change/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
...
/datum/trait/neutral/cyberpsycho/apply(datum/species/S, mob/living/complex/human/H)
	..(S,H)
