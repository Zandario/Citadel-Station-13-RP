...
/mob/living/complex/human/movement_delay(oldloc, direct)
	. = ..()
	...
	if(pulling)
		if(istype(pulling, /obj/item))
			...
			var/mob/living/complex/human/H = pulling
...
/mob/living/complex/human/proc/calculate_item_encumbrance()
...
/mob/living/complex/human/proc/calculate_turf_slowdown(turf/T, direct)
	if(!T)
		return 0
...
/mob/living/complex/human/Process_Spacemove(dir)
...
/mob/living/complex/human/Process_Spaceslipping(var/prob_slip = 5)
...
/mob/living/complex/human/handle_footstep(turf/T)
	if(is_incorporeal())
		return
...
/mob/living/complex/human/can_stumble_into(obj/O)
