...
// /mob/living/complex/human/dummy/mannequin/Initialize()
// 	. = ..()
// 	GLOB.mob_list -= src
// 	living_mob_list -= src
// 	dead_mob_list -= src
...
INITIALIZE_IMMEDIATE(/mob/living/complex/human/dummy/mannequin)
/mob/living/complex/human/dummy/mannequin

/mob/living/complex/human/dummy/mannequin/Initialize(mapload)
	. = ..()
	...
	for(var/mob/living/complex/human/dummy/mannequin/H in src.loc)
		for(var/i = 1, i <= 2, i++)
			if(!w_uniform)
...
/mob/living/complex/human/dummy/mannequin/plastic/Initialize(mapload)
	. = ..()
	...
	for(var/mob/living/complex/human/dummy/mannequin/plastic/H in src.loc)
		for(var/i = 1, i <= 2, i++)
			if(!w_uniform)
				var/list/options = typesof(/obj/item/clothing/under)
				var/PICK= options[rand(1,options.len)]
...
/mob/living/complex/human/dummy/mannequin/samurai/Initialize(mapload)
	. = ..()
	name = "Wooden Mannequin"
	real_name = "Wooden Mannequin"
	GLOB.mob_list -= src
	...
	for(var/mob/living/complex/human/dummy/mannequin/samurai/H in src.loc)
		for(var/i = 1, i <= 2, i++)
			if(!w_uniform)
...
/mob/living/complex/human/dummy/mannequin/animegirl/Initialize(mapload)
	. = ..()
	name = "Wooden Mannequin"
	real_name = "Wooden Mannequin"
	GLOB.mob_list -= src
	...
	for(var/mob/living/complex/human/dummy/mannequin/animegirl/H in src.loc)
		for(var/i = 1, i <= 2, i++)
			if(!w_uniform)
...
/mob/living/complex/human/dummy/mannequin/mummy/Initialize(mapload)
	. = ..()
	name = "Wooden Mannequin"
	real_name = "Wooden Mannequin"
	GLOB.mob_list -= src
	...
	for(var/mob/living/complex/human/dummy/mannequin/mummy/H in src.loc)
		for(var/i = 1, i <= 2, i++)
			if(!w_uniform)
...
/mob/living/complex/human/dummy/mannequin/scarecrow/Initialize(mapload)
	. = ..()
	name = "Wooden Mannequin"
	real_name = "Wooden Mannequin"
	GLOB.mob_list -= src
	...
	for(var/mob/living/complex/human/dummy/mannequin/scarecrow/H in src.loc)
		for(var/i = 1, i <= 2, i++)
			if(!w_uniform)
