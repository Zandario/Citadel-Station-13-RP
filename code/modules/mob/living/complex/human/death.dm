...
/mob/living/complex/human/death(gibbed)
	if(stat == DEAD)
		return
	...
	var/mob/living/simple/animal/borer/B
	...
	if(B)
		...
		remove_verb(src, /mob/living/complex/proc/release_control)
...
/mob/living/complex/human/proc/ChangeToHusk()
...
/mob/living/complex/human/proc/Drain()
	ChangeToHusk()
	mutations |= MUTATION_HUSK
	return

/mob/living/complex/human/proc/ChangeToSkeleton()
