...
/mob/living/complex/human/can_eat(food, feedback = TRUE)
...
/mob/living/complex/human/can_force_feed(feeder, food, feedback = TRUE)
	var/list/status = can_eat_status()
	if(status[1] == HUMAN_EATING_NO_ISSUE)
		return TRUE
	if(feedback)
...
/mob/living/complex/human/proc/can_eat_status()
	if(!check_has_mouth())
...
/mob/living/complex/human/proc/get_coverage()
...
/mob/living/complex/human/break_cloak()
...
/mob/living/complex/human/is_cloaked()
	// Changeling visible camo.
...
/mob/living/complex/human/get_ear_protection()
	var/sum = 0
...
/mob/living/complex/human/get_gender()
 ...
 */
/mob/living/complex/human/isSynthetic()
	...
	if(T && T.robotic >= ORGAN_ROBOT)
		add_verb(T.owner, /mob/living/complex/human/proc/self_diagnostics)
		add_verb(T.owner, /mob/living/complex/human/proc/setmonitor_state)
 ...
 */
/mob/living/complex/human/proc/looksSynthetic()
	var/obj/item/organ/external/T = organs_by_name[BP_TORSO]
...
/mob/living/complex/human/proc/get_FBP_type()
	if(!isSynthetic())
		return FBP_NONE
...
/mob/living/complex/human/recalculate_vis()
...
/mob/living/complex/human/get_restraining_bolt()
...
/mob/living/complex/human/can_see_reagents()
	. = ..()
