/mob/living/complex/human/ai_controlled
	name = "Nameless Joe"
...
/mob/living/complex/human/ai_controlled/Initialize(mapload)
	if(generate_gender)
...
/mob/living/complex/human/ai_controlled/replicant
...
/mob/living/complex/human/ai_controlled/replicant/Initialize(mapload)
	. = ..()
