...
/mob/living/complex/human/proc/try_remove_splints(mob/user)
	visible_message(
...
// Remove all splints.
/mob/living/complex/human/proc/remove_splints(var/mob/living/user)
...
/mob/living/complex/human/proc/try_toggle_internals(mob/user)
	visible_message(
...
/mob/living/complex/human/proc/toggle_internals(var/mob/living/user)
	if(internal)
...
/mob/living/complex/human/proc/strip_menu_check_valid_internals_items()
