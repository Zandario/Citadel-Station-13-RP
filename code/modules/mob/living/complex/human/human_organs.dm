 ...
 */
/mob/living/complex/human/proc/has_organ(name)
	var/obj/item/organ/external/O = organs_by_name[name]
	return (O && !O.is_stump())

/mob/living/complex/human/proc/recheck_bad_external_organs()
...
/mob/living/complex/human/proc/handle_organs(dt)
...
/mob/living/complex/human/proc/handle_stance()
...
/mob/living/complex/human/proc/handle_grasp()
	if(!l_hand && !r_hand)
		return
...
//Handles chem traces
/mob/living/complex/human/proc/handle_trace_chems()
	//New are added for reagents to random organs.
	for(var/datum/reagent/A in reagents.reagent_list)
		var/obj/item/organ/O = pick(organs)
		O.trace_chemicals[A.name] = 100

/mob/living/complex/human/proc/sync_organ_dna()
