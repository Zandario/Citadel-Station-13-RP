/mob/living/complex/human/resist_restraints()
...
/mob/living/complex/human/proc/escape_straight_jacket()
...
/mob/living/complex/human/proc/can_break_straight_jacket()
	if((MUTATION_HULK in mutations) || species.can_shred(src,1))
		return TRUE
	return FALSE

/mob/living/complex/human/proc/break_straight_jacket()
	visible_message(
...
/mob/living/complex/human/can_break_cuffs()
