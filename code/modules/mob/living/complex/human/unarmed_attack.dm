...
/datum/unarmed_attack/proc/is_usable(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone)
	if(user.restrained())
		return FALSE
...
/datum/unarmed_attack/proc/apply_effects(var/mob/living/complex/human/user,var/mob/living/complex/human/target,var/armour,var/attack_damage,var/zone)
...
/datum/unarmed_attack/proc/show_attack(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone, var/attack_damage)
	var/obj/item/organ/external/affecting = target.get_organ(zone)
	user.visible_message("<span class='warning'>[user] [pick(attack_verb)] [target] in the [affecting.name]!</span>")
	playsound(user.loc, attack_sound, 25, 1, -1)

/datum/unarmed_attack/proc/handle_eye_attack(var/mob/living/complex/human/user, var/mob/living/complex/human/target)
...
/datum/unarmed_attack/proc/unarmed_override(var/mob/living/complex/human/user,var/mob/living/complex/human/target,var/zone)
...
/datum/unarmed_attack/bite/is_usable(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone)
...
/datum/unarmed_attack/punch/show_attack(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone, var/attack_damage)
	var/obj/item/organ/external/affecting = target.get_organ(zone)
...
/datum/unarmed_attack/kick/is_usable(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone)
	if (user.legcuffed)
		return FALSE
...
/datum/unarmed_attack/kick/get_unarmed_damage(var/mob/living/complex/human/user)
	var/obj/item/clothing/shoes = user.shoes
	if(!istype(shoes))
		return damage
	return damage + (shoes ? shoes.force : 0)

/datum/unarmed_attack/kick/show_attack(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone, var/attack_damage)
	var/obj/item/organ/external/affecting = target.get_organ(zone)
	var/datum/gender/TT = GLOB.gender_datums[target.get_visible_gender()]
	var/organ = affecting.name
...
/datum/unarmed_attack/stomp/is_usable(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone)
...
/datum/unarmed_attack/stomp/get_unarmed_damage(var/mob/living/complex/human/user)
	var/obj/item/clothing/shoes = user.shoes
	return damage + (shoes ? shoes.force : 0)

/datum/unarmed_attack/stomp/show_attack(var/mob/living/complex/human/user, var/mob/living/complex/human/target, var/zone, var/attack_damage)
	var/obj/item/organ/external/affecting = target.get_organ(zone)
	var/organ = affecting.name
	var/obj/item/clothing/shoes = user.shoes
	var/datum/gender/TU = GLOB.gender_datums[user.get_visible_gender()]
