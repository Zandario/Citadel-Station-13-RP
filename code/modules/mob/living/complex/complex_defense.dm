...
/mob/living/complex/resolve_item_attack(obj/item/I, mob/living/user, var/effective_force, var/hit_zone)
	if(check_neckgrab_attack(I, user, hit_zone))
		return null
	..()

/mob/living/complex/standard_weapon_hit_effects(obj/item/I, mob/living/user, var/effective_force, var/blocked, var/soaked, var/hit_zone)
...
/mob/living/complex/proc/check_neckgrab_attack(obj/item/W, mob/user, var/hit_zone)
...
/mob/living/complex/electrocute_act(var/shock_damage, var/obj/source, var/siemens_coeff = 1.0, var/def_zone = null, var/stun = 1)
...
// Knifing
/mob/living/complex/proc/attack_throat(obj/item/W, obj/item/grab/G, mob/user)
...
/mob/living/complex/proc/shank_attack(obj/item/W, obj/item/grab/G, mob/user, hit_zone)
...
/mob/living/complex/proc/shank_armor_helper(obj/item/W, obj/item/grab/G, mob/user)
	var/damage = W.force
	var/damage_mod = 1
	if(W.edge)
