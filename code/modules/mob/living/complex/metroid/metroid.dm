...
/mob/living/complex/slime/Initialize(mapload, colour = "grey")
...
/mob/living/complex/slime/movement_delay()
	. = ..()
...
/mob/living/complex/slime/Bump(atom/movable/AM as mob|obj, yes)
	if ((!(yes) || now_pushing))
		return
	now_pushing = 1
	...
	if(ismob(AM))
		...
		if(is_adult)
			if(istype(tmob, /mob/living/complex/human))
				if(prob(90))
					now_pushing = 0
					return
		else
...
/mob/living/complex/slime/Process_Spacemove()
	return 2

/mob/living/complex/slime/statpanel_data(client/C)
	. = ..()
...
/mob/living/complex/slime/adjustFireLoss(var/amount,var/include_robo)
	..(-abs(amount)) // Heals them
	return

/mob/living/complex/slime/bullet_act(var/obj/item/projectile/Proj)
	attacked += 10
	..(Proj)
	return 0

/mob/living/complex/slime/emp_act(severity)
	powerlevel = 0 // oh no, the power!
	..()

/mob/living/complex/slime/legacy_ex_act(severity)
	..()
...
/mob/living/complex/slime/attack_ui(slot)
	return

/mob/living/complex/slime/attack_hand(mob/living/complex/human/M as mob)
...
/mob/living/complex/slime/attackby(obj/item/W, mob/user)
	if(W.force > 0)
		attacked += 10
		if(prob(25))
...
/mob/living/complex/slime/restrained()
	return 0

/mob/living/complex/slime/var/co2overloadtime = null
/mob/living/complex/slime/var/temperature_resistance = T0C+75

/mob/living/complex/slime/toggle_throw_mode()
	return

/mob/living/complex/slime/proc/gain_nutrition(var/amount)
	nutrition += amount
