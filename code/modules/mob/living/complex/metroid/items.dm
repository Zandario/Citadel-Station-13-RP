...
/obj/item/slimepotion/docility/attack(mob/living/complex/slime/M as mob, mob/user as mob)
	if(!istype(M, /mob/living/complex/slime))//If target is not a slime.
...
/obj/item/slimepotion/stabilizer/attack(mob/living/complex/slime/M, mob/user)
	if(!isslime(M))
...
/obj/item/slimepotion2
	...
	attack(mob/living/complex/slime/M as mob, mob/user as mob)
		if(!istype(M, /mob/living/complex/slime/))//If target is not a slime.
			to_chat(user, "<span class='warning'> The potion only works on slimes!</span>")
			return ..()
		if(M.stat)
...
/obj/effect/golemrune
	...
	attack_hand(mob/living/user as mob)
		...
		if(!ghost)
			...
			return
		var/mob/living/complex/human/G = new(src.loc)
...
/mob/living/complex/slime/has_eyes()
	return 0
