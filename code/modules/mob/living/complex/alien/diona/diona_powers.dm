...
/mob/living/complex/alien/diona/proc/merge()
	...
	if(istype(src.loc,/mob/living/complex))
		remove_verb(src, /mob/living/complex/alien/diona/proc/merge)
		return
	...
	for(var/mob/living/complex/C in view(1,src))
		...
		if(istype(C,/mob/living/complex/human))
			var/mob/living/complex/human/D = C
...
/mob/living/complex/alien/diona/proc/do_merge(var/mob/living/complex/human/H)
	...
	loc = H
	add_verb(src, /mob/living/complex/alien/diona/proc/split)
	remove_verb(src, /mob/living/complex/alien/diona/proc/merge)
	return 1

/mob/living/complex/alien/diona/proc/split()
	...
	if(!(istype(src.loc,/mob/living/complex)))
		remove_verb(src, /mob/living/complex/alien/diona/proc/split)
		return
	...
	remove_verb(src, /mob/living/complex/alien/diona/proc/split)
	add_verb(src, /mob/living/complex/alien/diona/proc/merge)

	if(istype(M))
		for(var/atom/A in M.contents)
			if(istype(A,/mob/living/simple/animal/borer) || istype(A,/obj/item/holder))
				return
