...
/mob/living/complex/alien/Initialize(mapload)
...
/mob/living/complex/alien/statpanel_data(client/C)
	. = ..()
	STATPANEL_DATA_LINE("")
	STATPANEL_DATA_LINE("Progress: [amount_grown]/[max_grown]")

/mob/living/complex/alien/restrained()
	return 0

/mob/living/complex/alien/request_strip_menu(mob/user, ignore_adjacency = FALSE, ignore_incapacitation = FALSE)
	return FALSE

/mob/living/complex/alien/cannot_use_vents()
	return
