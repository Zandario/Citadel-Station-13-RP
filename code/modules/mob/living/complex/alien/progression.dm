/mob/living/complex/alien/verb/evolve()
	...
	if(!adult_form)
		remove_verb(src, /mob/living/complex/alien/verb/evolve)
		return
	...
	var/mob/living/complex/human/adult = new adult_form(get_turf(src))
...
/mob/living/complex/alien/proc/update_progression()
	if(amount_grown < max_grown)
		amount_grown++
	return

/mob/living/complex/alien/proc/confirm_evolution()
	return

/mob/living/complex/alien/proc/show_evolution_blurb()
	return
