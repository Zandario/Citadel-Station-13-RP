/mob/living/complex/brain/handle_breathing()
	return

/mob/living/complex/brain/handle_mutations_and_radiation(seconds)
	// todo; deal with this
...
/mob/living/complex/brain/handle_environment(datum/gas_mixture/environment)
	if(!environment)
		return
...
/mob/living/complex/brain/proc/handle_temperature_damage(body_part, exposed_temperature, exposed_intensity)
...
/mob/living/complex/brain/handle_chemicals_in_body()
	chem_effects.Cut()
...
/mob/living/complex/brain/handle_regular_UI_updates()	//TODO: comment out the unused bits >_>
	updatehealth()
...
/mob/living/complex/brain/handle_regular_hud_updates()
	if (healths)
		if (stat != 2)
			switch(health)
				if(100 to INFINITY)
