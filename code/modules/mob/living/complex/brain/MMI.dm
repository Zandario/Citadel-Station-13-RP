...
/obj/item/mmi/proc/transfer_identity(var/mob/living/complex/human/H)//Same deal as the regular brain proc. Used for human-->robot people.
	brainmob = new(src)
...
/obj/item/mmi/digital/examine(mob/user)
	...
	if(brainmob)
		var/mob/living/complex/brain/B = brainmob
...
/obj/item/mmi/digital/transfer_identity(var/mob/living/complex/H)
	brainmob.dna = H.dna
...
/obj/item/mmi/digital/robot/transfer_identity(var/mob/living/complex/H)
	..()
	if(brainmob.mind)
...
/obj/item/mmi/digital/posibrain/transfer_identity(var/mob/living/complex/H)
	..()
	if(brainmob.mind)
