...
/mob/living/complex/brain/Initialize(mapload)
	. = ..()
	var/datum/reagents/R = new/datum/reagents(1000)
	reagents = R
	R.my_atom = src

/mob/living/complex/brain/Destroy()
...
/mob/living/complex/brain/update_canmove()
...
/mob/living/complex/brain/isSynthetic()
	return istype(loc, /obj/item/mmi)

///mob/living/complex/brain/binarycheck()//No binary without a binary communication device
//	return isSynthetic()
