/mob/living/complex/resist_fire()
...
/mob/living/complex/resist_restraints()
	var/obj/item/I = null
	if(handcuffed)
		I = handcuffed
	else if(legcuffed)
...
/mob/living/complex/proc/reduce_cuff_time()
	return FALSE

/mob/living/complex/proc/cuff_resist(obj/item/handcuffs/I, breakouttime = 1200, cuff_break = 0)
...
/mob/living/complex/proc/can_break_cuffs()
