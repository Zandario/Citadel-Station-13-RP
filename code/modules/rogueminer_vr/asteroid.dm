...
/datum/rogue/asteroid/predef/cargo/angry/New()
	...
	spot_add(2,2,/mob/living/simple/animal/space/alien) //GRRR
...
/datum/rogue/asteroid/predef/cargo_large/New()
	...
	if(prob(30))
		spot_add(3,3,/mob/living/simple/animal/space/alien/sentinel/praetorian) //And maybe a big friend for big loot.
