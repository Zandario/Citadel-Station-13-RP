...
/datum/weather_holder/miaphus
	...
	allowed_weather_types = list(
		...
		WEATHER_OVERCAST	= new /datum/weather/miaphus/overcast(),
		WEATHER_LIGHT_SNOW	= new /datum/weather/miaphus/light_snow(),
		WEATHER_SNOW		= new /datum/weather/miaphus/snow(),
		WEATHER_BLIZZARD	= new /datum/weather/miaphus/blizzard(),
		WEATHER_RAIN		= new /datum/weather/miaphus/rain(),
		WEATHER_STORM		= new /datum/weather/miaphus/storm(),
		WEATHER_HAIL		= new /datum/weather/miaphus/hail(),
		WEATHER_BLOOD_MOON	= new /datum/weather/miaphus/blood_moon(),
		WEATHER_EMBERFALL	= new /datum/weather/miaphus/emberfall(),
		WEATHER_ASH_STORM	= new /datum/weather/miaphus/ash_storm(),
		WEATHER_FALLOUT		= new /datum/weather/miaphus/fallout()
		)
