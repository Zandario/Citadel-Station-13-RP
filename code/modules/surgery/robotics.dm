...
/datum/surgery_step/robotics/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if (isslime(target))
		return 0
...
/datum/surgery_step/robotics/unscrew_hatch/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if(..())
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		return affected && affected.open == 0 && target_zone != O_MOUTH

/datum/surgery_step/robotics/unscrew_hatch/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/unscrew_hatch/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/unscrew_hatch/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/open_hatch/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if(..())
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		return affected && affected.open == 1

/datum/surgery_step/robotics/open_hatch/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/open_hatch/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/open_hatch/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/close_hatch/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if(..())
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		return affected && affected.open && target_zone != O_MOUTH

/datum/surgery_step/robotics/close_hatch/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/close_hatch/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/close_hatch/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/repair_brute/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if(..())
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/repair_brute/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message("[user] begins to patch damage to [target]'s [affected.name]'s support structure with \the [tool]." , \
	"You begin to patch damage to [target]'s [affected.name]'s support structure with \the [tool].")
	..()

/datum/surgery_step/robotics/repair_brute/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/repair_brute/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/repair_burn/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if(..())
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/repair_burn/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message("[user] begins to splice new cabling into [target]'s [affected.name]." , \
	"You begin to splice new cabling into [target]'s [affected.name].")
	..()

/datum/surgery_step/robotics/repair_burn/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/repair_burn/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/fix_organ_robotic/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if (!hasorgans(target))
		return
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	if(!affected) return
...
/datum/surgery_step/robotics/fix_organ_robotic/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if (!hasorgans(target))
		return
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/fix_organ_robotic/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if (!hasorgans(target))
		return
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/fix_organ_robotic/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if (!hasorgans(target))
		return
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/detatch_organ_robotic/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/detatch_organ_robotic/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/robotics/detatch_organ_robotic/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/robotics/detatch_organ_robotic/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/robotics/attach_organ_robotic/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	if(!(affected && (affected.robotic >= ORGAN_ROBOT)))
		return 0
	if(affected.open < 3)
...
/datum/surgery_step/robotics/attach_organ_robotic/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	user.visible_message("[user] begins reattaching [target]'s [target.op_stage.current_organ] with \the [tool].", \
	"You start reattaching [target]'s [target.op_stage.current_organ] with \the [tool].")
	..()

/datum/surgery_step/robotics/attach_organ_robotic/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/robotics/attach_organ_robotic/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	user.visible_message("<span class='warning'>[user]'s hand slips, disconnecting \the [tool].</span>", \
	"<span class='warning'>Your hand slips, disconnecting \the [tool].</span>")
...
/datum/surgery_step/robotics/install_mmi/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/robotics/install_mmi/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message("[user] starts installing \the [tool] into [target]'s [affected.name].", \
	"You start installing \the [tool] into [target]'s [affected.name].")
	..()

/datum/surgery_step/robotics/install_mmi/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/install_mmi/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/robotics/install_nymph/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/robotics/install_nymph/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/robotics/install_nymph/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message(
	...
	var/mob/living/complex/alien/diona/D = N.held_mob
	...
	add_verb(target, /mob/living/complex/human/proc/diona_split_nymph)
	add_verb(target, /mob/living/complex/human/proc/regenerate)
...
/datum/surgery_step/robotics/install_nymph/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	user.visible_message(
