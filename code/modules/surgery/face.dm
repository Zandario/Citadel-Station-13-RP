...
/datum/surgery_step/face/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	if (!hasorgans(target))
		return 0
...
/datum/surgery_step/generic/cut_face/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == O_MOUTH && target.op_stage.face == 0

/datum/surgery_step/generic/cut_face/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	user.visible_message("[user] starts to cut open [target]'s face and neck with \the [tool].", \
	"You start to cut open [target]'s face and neck with \the [tool].")
	..()

/datum/surgery_step/generic/cut_face/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/generic/cut_face/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/face/mend_vocal/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.face == 1

/datum/surgery_step/face/mend_vocal/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	user.visible_message("[user] starts mending [target]'s vocal cords with \the [tool].", \
	"You start mending [target]'s vocal cords with \the [tool].")
	..()

/datum/surgery_step/face/mend_vocal/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/face/mend_vocal/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/face/fix_face/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.face == 2

/datum/surgery_step/face/fix_face/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/face/fix_face/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/face/fix_face/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/face/cauterize/can_use(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.face > 0

/datum/surgery_step/face/cauterize/begin_step(mob/user, mob/living/complex/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/face/cauterize/end_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/face/cauterize/fail_step(mob/living/user, mob/living/complex/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
