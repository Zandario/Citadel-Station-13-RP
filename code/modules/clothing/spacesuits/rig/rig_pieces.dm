...
/obj/item/clothing/head/helmet/space/rig
	...
	sprite_sheets = list(
		...
		SPECIES_PHORONOID		= 'icons/mob/species/phoronoid/head.dmi'
		)
	species_restricted = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_TAJARA, SPECIES_UNATHI, SPECIES_NEVREAN, SPECIES_AKULA, SPECIES_SERGAL, SPECIES_ZORREN_FLAT, SPECIES_ZORREN_HIGH, SPECIES_VULPKANIN, SPECIES_PROMETHEAN, SPECIES_XENOHYBRID, SPECIES_VOX, SPECIES_TESHARI, SPECIES_VASILISSAN, SPECIES_RAPALA, SPECIES_ALRAUNE, SPECIES_ZADDAT, SPECIES_PHORONOID, SPECIES_APIDAEN, SPECIES_VETALA_RUDDY, SPECIES_VETALA_PALE, SPECIES_AURIL, SPECIES_DREMACHIR)
...
/obj/item/clothing/suit/space/rig
	...
	sprite_sheets = list(
		...
		SPECIES_PHORONOID			= 'icons/mob/species/phoronoid/suit.dmi'
        )
	species_restricted = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_TAJARA, SPECIES_UNATHI, SPECIES_NEVREAN, SPECIES_AKULA, SPECIES_SERGAL, SPECIES_ZORREN_FLAT, SPECIES_ZORREN_HIGH, SPECIES_VULPKANIN, SPECIES_PROMETHEAN, SPECIES_XENOHYBRID, SPECIES_VOX, SPECIES_TESHARI, SPECIES_VASILISSAN, SPECIES_RAPALA, SPECIES_ALRAUNE, SPECIES_ZADDAT, SPECIES_PHORONOID, SPECIES_APIDAEN, SPECIES_VETALA_RUDDY, SPECIES_VETALA_PALE, SPECIES_AURIL, SPECIES_DREMACHIR)
