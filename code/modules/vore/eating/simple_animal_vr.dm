...
//
/mob/living/simple/proc/animal_nom(var/mob/living/T in living_mobs(1))
	set name = "Animal Nom"
	set category = "IC"
	...
	if (stat != CONSCIOUS)
		return
	if (istype(src,/mob/living/simple/animal/passive/mouse) && T.ckey == null)
		return
 ...
 * Added as a verb in /mob/living/simple/init_vore() if vore is enabled for this mob.
 */
/mob/living/simple/proc/toggle_digestion()
...
// Added as a verb in /mob/living/simple/init_vore() if vore is enabled for this mob.
/mob/living/simple/proc/toggle_fancygurgle()
