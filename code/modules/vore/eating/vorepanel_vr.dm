...
/datum/vore_look/proc/gen_ui(var/mob/living/user)
	...
	switch(user.permit_sizegun)
		if(TRUE)
			nightmare_list += "<a style='background:#173d15;' href='?src=\ref[src];toggle_permit_sizegun=1'>Allow Sizegun (Currently: ON)</a>"
		if(FALSE)
			nightmare_list += "<a style='background:#990000;' href='?src=\ref[src];toggle_permit_sizegun=1'>Allow Sizegun (Currently: OFF)</a>"
	switch(user.permit_size_trample)
		if(TRUE)
			nightmare_list += "<a style='background:#173d15;' href='?src=\ref[src];toggle_permit_trample=1'>Permit Step-On (Size >75%) (Currently: ON)</a>"
		if(FALSE)
			nightmare_list += "<a style='background:#990000;' href='?src=\ref[src];toggle_permit_trample=1'>Permit Step-On  (Size >75%) (Currently: OFF)</a>"
	switch(user.permit_size_pickup)
		if(TRUE)
			nightmare_list += "<a style='background:#173d15;' href='?src=\ref[src];toggle_permit_pickup=1'>Permit Instant Pickup (Size >75%) (Currently: ON)</a>"
		if(FALSE)
			nightmare_list += "<a style='background:#990000;' href='?src=\ref[src];toggle_permit_pickup=1'>Permit Instant Pickup (Size >75%) (Currently: OFF)</a>"
	switch(user.permit_stripped)
		if(TRUE)
			nightmare_list += "<a style='background:#173d15;' href='?src=\ref[src];toggle_permit_stripped=1'>Allow Stripper Gun (Currently: ON)</a>"
		if(FALSE)
			nightmare_list += "<a style='background:#990000;' href='?src=\ref[src];toggle_permit_stripped=1'>Allow Stripper Gun (Currently: OFF)</a>"
