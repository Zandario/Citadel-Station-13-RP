datum/sprite_accessory/marking/tatoo
	abstract_type = /datum/sprite_accessory/marking/tatoo
...
datum/sprite_accessory/marking/tatoo/tat_inmon2
	...
	id = "marking_tattoo_groin_inmon2"
