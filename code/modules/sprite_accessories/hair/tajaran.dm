...
datum/sprite_accessory/hair/taj_ears
	name = "Tajaran Ears"
	id = "hair_tajaran_ears"
	icon_state = "ears_plain"
	species_allowed = list(SPECIES_VULPKANIN, SPECIES_XENOCHIMERA, SPECIES_TAJ, SPECIES_SERGAL, SPECIES_ZORREN_FLAT, SPECIES_ZORREN_HIGH, SPECIES_PROTEAN, SPECIES_CUSTOM)
	apply_restrictions = TRUE

datum/sprite_accessory/hair/taj_ears_clean
	name = "Tajara Clean"
	id = "hair_tajaran_clean"
