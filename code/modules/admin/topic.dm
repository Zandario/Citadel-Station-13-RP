/datum/admins/Topic(href, href_list)
	...
	if(href_list["dbsearchckey"] || href_list["dbsearchadmin"])
		...
		switch(href_list["simplemake"])
			...
			if("slime")				M.change_mob_type( /mob/living/simple/slime/xenobio , null, null, delmob )
			if("monkey")			M.change_mob_type( /mob/living/complex/human/monkey , null, null, delmob )
			if("robot")				M.change_mob_type( /mob/living/silicon/robot , null, null, delmob )
			if("cat")				M.change_mob_type( /mob/living/simple/animal/passive/cat , null, null, delmob )
			if("runtime")			M.change_mob_type( /mob/living/simple/animal/passive/cat/runtime , null, null, delmob )
			if("corgi")				M.change_mob_type( /mob/living/simple/animal/passive/dog/corgi , null, null, delmob )
			if("ian")				M.change_mob_type( /mob/living/simple/animal/passive/dog/corgi/Ian , null, null, delmob )
			if("crab")				M.change_mob_type( /mob/living/simple/animal/passive/crab , null, null, delmob )
			if("coffee")			M.change_mob_type( /mob/living/simple/animal/passive/crab/Coffee , null, null, delmob )
			if("parrot")			M.change_mob_type( /mob/living/simple/animal/passive/bird/parrot , null, null, delmob )
			if("pollyparrot")		M.change_mob_type( /mob/living/simple/animal/passive/bird/parrot/polly , null, null, delmob )
			if("constructarmoured")	M.change_mob_type( /mob/living/simple/construct/juggernaut , null, null, delmob )
			if("constructbuilder")	M.change_mob_type( /mob/living/simple/construct/artificer , null, null, delmob )
			if("constructwraith")	M.change_mob_type( /mob/living/simple/construct/wraith , null, null, delmob )
			if("shade")				M.change_mob_type( /mob/living/simple/construct/shade , null, null, delmob )
