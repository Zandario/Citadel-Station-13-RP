/client/proc/smite_vr(var/mob/living/complex/human/target in GLOB.player_list)
	set name = "Smite (Vore)"
	...
	switch(smite_choice)
		if(SMITE_SHADEKIN_ATTACK)
			...
			var/mob/living/simple/shadekin/red/ai/shadekin = new(Ts)
			//Abuse of shadekin
		...
		if(SMITE_SHADEKIN_NOMF)
			var/list/kin_types = list(
				"Red Eyes (Dark)" =	/mob/living/simple/shadekin/red/dark,
				"Red Eyes (Light)" = /mob/living/simple/shadekin/red/white,
				"Red Eyes (Brown)" = /mob/living/simple/shadekin/red/brown,
				"Blue Eyes (Dark)" = /mob/living/simple/shadekin/blue/dark,
				"Blue Eyes (Light)" = /mob/living/simple/shadekin/blue/white,
				"Blue Eyes (Brown)" = /mob/living/simple/shadekin/blue/brown,
				"Purple Eyes (Dark)" = /mob/living/simple/shadekin/purple/dark,
				"Purple Eyes (Light)" = /mob/living/simple/shadekin/purple/white,
				"Purple Eyes (Brown)" = /mob/living/simple/shadekin/purple/brown,
				"Yellow Eyes (Dark)" = /mob/living/simple/shadekin/yellow/dark,
				"Yellow Eyes (Light)" = /mob/living/simple/shadekin/yellow/white,
				"Yellow Eyes (Brown)" = /mob/living/simple/shadekin/yellow/brown,
				"Green Eyes (Dark)" = /mob/living/simple/shadekin/green/dark,
				"Green Eyes (Light)" = /mob/living/simple/shadekin/green/white,
				"Green Eyes (Brown)" = /mob/living/simple/shadekin/green/brown,
				"Orange Eyes (Dark)" = /mob/living/simple/shadekin/orange/dark,
				"Orange Eyes (Light)" = /mob/living/simple/shadekin/orange/white,
				"Orange Eyes (Brown)" = /mob/living/simple/shadekin/orange/brown,
				"Rivyr (Unique)" = /mob/living/simple/shadekin/blue/rivyr)
			...
			var/mob/living/simple/shadekin/shadekin = new kin_type(Tt)
			shadekin.real_name = shadekin.name
			shadekin.init_vore()
