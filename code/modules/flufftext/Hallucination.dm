...
/mob/living/complex/proc/handle_hallucinations()
...
/*obj/machinery/proc/mockpanel(list/buttons,start_txt,end_txt,list/mid_txts)
	...
	if(!mocktxt)
		...
		"OBJECTION!","Arrest Stephen Bowman","Engage Anti-Trenna Defenses","Increase Facility Director IQ","Retrieve Arms",\
...
proc/check_panel(mob/M)
	if (istype(M, /mob/living/complex/human) || istype(M, /mob/living/silicon/ai))
...
/obj/effect/fake_attacker
	...
	anchored = 1
	opacity = 0
	var/mob/living/complex/human/my_target = null
...
/proc/fake_attack(var/mob/living/target)
	...
	var/mob/living/complex/human/clone = null
