...
/datum/disease2/disease/proc/activate(var/mob/living/complex/mob)
	if(dead)
		cure(mob)
		return
	...
	if(src.spreadtype == "Airborne")
		for(var/mob/living/complex/M in oview(1,mob))
...
/datum/disease2/disease/proc/cure(var/mob/living/complex/mob)
	for(var/datum/disease2/effectholder/e in effects)
...
/proc/virus2_lesser_infection()
	...
	for(var/mob/living/complex/human/G in GLOB.player_list)
