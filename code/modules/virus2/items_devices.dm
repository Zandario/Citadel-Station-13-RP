...
/obj/item/virusdish/attackby(var/obj/item/W as obj,var/mob/living/complex/user as mob)
	...
	if(prob(50))
		...
		if(virus2.infectionchance > 0)
			for(var/mob/living/complex/target in view(1, get_turf(src)))
...
/obj/item/ruinedvirusdish/attackby(var/obj/item/W as obj,var/mob/living/complex/user as mob)
	if(istype(W,/obj/item/hand_labeler) || istype(W,/obj/item/reagent_containers/syringe))
		return ..()
