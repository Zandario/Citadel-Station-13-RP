...
/datum/disease2/effect/mlem
	...
	stage = 1
	chance_maxm = 25
	activate(var/mob/living/complex/mob,var/multiplier)
...
/datum/disease2/effect/spin/activate(var/mob/living/complex/mob,var/multiplier)
	if(mob.is_buckled())
...
/datum/disease2/effect/lang/activate(var/mob/living/complex/mob,var/multiplier)
...
/datum/disease2/effect/size/activate(var/mob/living/complex/mob,var/multiplier)
...
/datum/disease2/effect/flip/activate(var/mob/living/complex/mob,var/multiplier) //Remind me why mob is carbon...?
	if(ishuman(mob))
