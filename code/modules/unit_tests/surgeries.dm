/datum/unit_test/amputation/Run()
	var/mob/living/complex/human/patient = allocate(/mob/living/complex/human)
...
/datum/unit_test/head_transplant/Run()
	var/mob/living/complex/human/user = allocate(/mob/living/complex/human)
	var/mob/living/complex/human/alice = allocate(/mob/living/complex/human)
	var/mob/living/complex/human/bob = allocate(/mob/living/complex/human)
...
/datum/unit_test/multiple_surgeries/Run()
	var/mob/living/complex/human/user = allocate(/mob/living/complex/human)
	var/mob/living/complex/human/patient_zero = allocate(/mob/living/complex/human)
	var/mob/living/complex/human/patient_one = allocate(/mob/living/complex/human)
...
/datum/unit_test/tend_wounds/Run()
	...
	var/mob/living/complex/human/naked_patient = allocate(/mob/living/complex/human)
	naked_patient.take_overall_damage(100)

	var/mob/living/complex/human/clothed_patient = allocate(/mob/living/complex/human)
