/datum/unit_test/harm_punch/Run()
	var/mob/living/complex/human/puncher = allocate(/mob/living/complex/human/consistent)
	var/mob/living/complex/human/victim = allocate(/mob/living/complex/human/consistent)
...
/datum/unit_test/harm_melee/Run()
	var/mob/living/complex/human/tider = allocate(/mob/living/complex/human/consistent)
	var/mob/living/complex/human/victim = allocate(/mob/living/complex/human/consistent)
...
/datum/unit_test/harm_different_damage/Run()
	var/mob/living/complex/human/attacker = allocate(/mob/living/complex/human/consistent)
	var/mob/living/complex/human/victim = allocate(/mob/living/complex/human/consistent)
