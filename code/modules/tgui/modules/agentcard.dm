/datum/tgui_module_old/agentcard
	name = "Agent Card"
	tgui_id = "AgentCard"

/datum/tgui_module_old/agentcard/ui_data(mob/user, tgui/ui, datum/ui_state/state)
	var/list/data = ..()
...
/datum/tgui_module_old/agentcard/ui_act(action, list/params, tgui/ui)
	if(..())
		return TRUE
