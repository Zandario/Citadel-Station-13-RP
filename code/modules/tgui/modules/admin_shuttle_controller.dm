...
/datum/tgui_module_old/admin_shuttle_controller/ui_data(mob/user, tgui/ui, datum/ui_state/state)
	var/list/data = ..()
...
/datum/tgui_module_old/admin_shuttle_controller/ui_act(action, list/params, tgui/ui)
	if(..())
		return
