...
/datum/weather_holder/classg
	...
	allowed_weather_types = list(
		...
		WEATHER_OVERCAST	= new /datum/weather/classg/overcast(),
		WEATHER_RAIN		= new /datum/weather/classg/rain(),
		WEATHER_STORM		= new /datum/weather/classg/storm(),
		WEATHER_BLOOD_MOON	= new /datum/weather/classg/blood_moon(),
		)
...
/datum/weather/classg/rain/process_effects()
	..()
...
/datum/weather/classg/storm/process_effects()
	..()
	for(var/mob/living/L in GLOB.living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/classg/storm/proc/handle_lightning()
...
/datum/weather/classg/blood_moon
	name = "blood moon"
	light_modifier = 0.5
	light_color = "#FF0000"
