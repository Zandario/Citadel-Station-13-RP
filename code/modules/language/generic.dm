...
/datum/language/noise
	...
	desc = "Noises"
	key = ""
	flags = LANGUAGE_FLAG_RESTRICTED|LANGUAGE_FLAG_NONGLOBAL|LANGUAGE_FLAG_INNATE|LANGUAGE_FLAG_NO_TALK_MSG|LANGUAGE_FLAG_NO_STUTTER
...
/datum/language/vernal
	...
	syllables = list(
		"shh", "fssh", "rustle", "snap", "kssh", "sffh", "mssh", "creak",
...
/datum/language/gibberish
	...
	flags = LANGUAGE_FLAG_RESTRICTED|LANGUAGE_FLAG_NONGLOBAL
