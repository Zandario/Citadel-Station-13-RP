...
/obj/item/organ/external/take_damage(brute, burn, sharp, edge, used_weapon = null, list/forbidden_limbs = list())
	...
	if(owner && loc == owner && !is_stump())
		if(!cannot_amputate && config_legacy.limbs_can_break && (brute_dam + burn_dam + brute + burn + spillover) >= (max_damage * config_legacy.organ_health_multiplier))
...
/obj/item/organ/external/proc/get_pain(var/amount)
	if(!organ_can_feel_pain() || robotic >= ORGAN_ROBOT)
		return 0
	return pain
