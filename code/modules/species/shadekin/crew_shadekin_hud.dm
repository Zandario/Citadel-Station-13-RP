...
atom/movable/screen/movable/ability_master/proc/add_crew_shadekin_ability(object_given, verb_given, name_given, ability_icon_given, arguments)
	...
	if(!verb_given)
		message_admins("ERROR: add_crew_shadekin_ability() was not given a verb/proc in its arguments.")
	if(get_ability_by_proc_ref(verb_given))
		return // Duplicate
	var/atom/movable/screen/ability/verb_based/crew_shadekin/A = new /atom/movable/screen/ability/verb_based/crew_shadekin()
