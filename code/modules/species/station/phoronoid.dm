/datum/species/phoronoid
	...
	icobase = 'icons/mob/human_races/species/phoronoid/r_plasmaman_sb.dmi'
	primitive_form = null
	...
	wikilink = "https://citadel-station.net/wikiRP/index.php?title=Phoronids"
...
/datum/species/phoronoid/handle_environment_special(var/mob/living/carbon/human/H)
	var/turf/T = H.loc
	if(!T) return
...
/datum/species/phoronoid/equip_survival_gear(var/mob/living/carbon/human/H, var/extendedtank = 0,var/comprehensive = 0)
	. = ..()
