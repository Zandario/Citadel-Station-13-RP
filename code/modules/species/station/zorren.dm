/datum/species/hi_zorren
	...
	name_plural = "Zorren"
	icobase = 'icons/mob/human_races/species/zorren/r_fox_vr.dmi'
	deform = 'icons/mob/human_races/species/zorren/r_def_fox.dmi'
	tail = "tail"
	icobase_tail = 1
...
/datum/species/fl_zorren
	...
	name_plural = "Zorren"
	icobase = 'icons/mob/human_races/species/zorren/r_fennec_vr.dmi'
	deform = 'icons/mob/human_races/species/zorren/r_def_fennec.dmi'
	tail = "tail"
	icobase_tail = 1
	unarmed_types = list(/datum/unarmed_attack/stomp, /datum/unarmed_attack/kick, /datum/unarmed_attack/claws, /datum/unarmed_attack/bite/sharp)
	inherent_verbs = list(/mob/living/carbon/human/proc/lick_wounds)
