/datum/species/tajaran
	name = SPECIES_TAJARA
	name_plural = "Tajaran"
	icobase = 'icons/mob/human_races/species/tajara/r_tajaran_vr.dmi'
	deform = 'icons/mob/human_races/species/tajara/r_def_tajaran_vr.dmi'
	tail = "tajtail"
	...
	primitive_form = SPECIES_TAJARA_MONKEY
