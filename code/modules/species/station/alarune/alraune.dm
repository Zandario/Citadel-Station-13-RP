/datum/species/alraune
	...
	color_mult = 1
	icobase = 'icons/mob/human_races/species/human/r_human_vr.dmi'
	deform = 'icons/mob/human_races/species/human/r_def_human_vr.dmi'
	flesh_color = "#9ee02c"
	...
	wikilink = "https://citadel-station.net/wikiRP/index.php?title=Alraune"
