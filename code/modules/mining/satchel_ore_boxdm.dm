...
/obj/structure/ore_box/verb/empty_box()
	...
	if(!istype(usr, /mob/living/complex/human) && !istype(usr, /mob/living/silicon/robot)) //Only living, intelligent creatures with gripping aparatti can empty ore boxes.
