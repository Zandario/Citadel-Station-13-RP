...
/datum/seed/proc/do_thorns(var/mob/living/complex/human/target, var/obj/item/fruit, var/target_limb)

	if(!get_trait(TRAIT_CARNIVOROUS))
		return

	if(!istype(target))
		if(istype(target, /mob/living/simple/animal/passive/mouse))
			new /obj/effect/decal/remains/mouse(get_turf(target))
			qdel(target)
		else if(istype(target, /mob/living/simple/animal/passive/lizard))
...
/datum/seed/proc/do_sting(var/mob/living/complex/human/target, var/obj/item/fruit)
