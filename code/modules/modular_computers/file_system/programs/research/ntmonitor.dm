...
/datum/nano_module/computer_ntnetmonitor/nano_ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1, datum/topic_state/state = default_nano_state)
	if(!ntnet_global)
		return
