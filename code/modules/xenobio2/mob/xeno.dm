...
//Life additions
/mob/living/simple/xeno/Life(seconds, times_fired)
	if(stasis)
		stasis--
		if(stasis < 0)
			stasis = 0
...
/mob/living/simple/xeno/Initialize(mapload)
	traitdat = new()
	ProcessTraits()
	. =..()
	if(colored)
