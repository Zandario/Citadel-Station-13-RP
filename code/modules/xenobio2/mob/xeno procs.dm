...
*/
/mob/living/simple/xeno/proc/ProcessTraits()
...
/mob/living/simple/xeno/proc/handle_reagents()
	if(!stasis)
		if(!reagents)
			return
...
/mob/living/simple/xeno/proc/diverge()
	var/datum/xeno/traits/newtraits = new()
	newtraits.copy_traits(traitdat)
	return newtraits

/mob/living/simple/xeno/proc/Mutate()
	traitdat = diverge()
	nameVar = "mutated"
	if((COLORMUT & mutable))
...
/mob/living/simple/xeno/proc/RandomizeTraits()
	return

/mob/living/simple/xeno/hear_say(var/message, var/verb = "says", var/datum/language/language, var/alt_name = "",var/italics = 0, var/mob/speaker = null)
...
/mob/living/simple/xeno/proc/ProcessSpeechBuffer()
	if(speech_buffer.len)
		...
		speech_buffer.Cut()
//
/mob/living/simple/xeno/proc/BuildReagentLists()
	return

/mob/living/simple/xeno/bullet_act(var/obj/item/projectile/P)
...
/mob/living/simple/xeno/proc/RandomChemicals()
