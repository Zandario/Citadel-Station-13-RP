...
/datum/reagent/toxin/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/toxin/affect_touch(mob/living/complex/M, alien, removed)
...
/datum/reagent/toxin/neurotoxic_protein/affect_blood(mob/living/complex/M, alien, removed)
	..()
	if(alien != IS_DIONA)
...
/datum/reagent/toxin/hydrophoron/affect_touch(mob/living/complex/M, alien, removed)
...
/datum/reagent/toxin/hydrophoron/affect_blood(mob/living/complex/M, alien, removed)
	..()
	if(alien == IS_SLIME)
...
/datum/reagent/toxin/phoron/affect_touch(mob/living/complex/M, alien, removed)
	..()
...
/datum/reagent/toxin/phoron/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_VOX)
...
/datum/reagent/toxin/cyanide/affect_blood(mob/living/complex/M, alien, removed)
	..()
...
/datum/reagent/toxin/mold/affect_ingest(mob/living/complex/M, alien, removed)
	..()
	M.adjustToxLoss(strength * removed)
	if(prob(5))
		M.vomit()
...
/datum/reagent/toxin/expired_medicine/affect_blood(mob/living/complex/M, alien, removed)
	..()
	if(prob(5))
		M.vomit()

/datum/reagent/toxin/expired_medicine/affect_ingest(mob/living/complex/M, alien, removed)
...
/datum/reagent/toxin/stimm/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_TAJARA)
		removed *= 1.25
	..()
	if(prob(15))
...
/datum/reagent/toxin/potassium_chloride/affect_blood(mob/living/complex/M, alien, removed)
	..()
	if(alien == IS_SLIME)
		M.adjustFireLoss(removed * 2)

/datum/reagent/toxin/potassium_chloride/overdose(mob/living/complex/M, alien)
	..()
	if(ishuman(M))
...
/datum/reagent/toxin/potassium_chlorophoride/affect_blood(mob/living/complex/M, alien, removed)
	..()
	if(ishuman(M))
		var/mob/living/complex/human/H = M
		if(H.stat != 1)
...
/datum/reagent/toxin/zombiepowder/affect_blood(mob/living/complex/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/toxin/lichpowder/affect_touch(mob/living/complex/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.status_flags |= FAKEDEATH
...
/datum/reagent/toxin/fertilizer/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/toxin/plantbgone/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_ALRAUNE)
		M.adjustToxLoss(50 * removed)

/datum/reagent/toxin/plantbgone/affect_touch(mob/living/complex/M, alien, removed)
	if(alien == IS_ALRAUNE)
		M.adjustToxLoss(50 * removed)
...
/datum/reagent/toxin/pestbgone/affect_touch(mob/living/complex/M, alien, removed)
	if(alien == IS_APIDAEN)
		M.adjustToxLoss(50 * removed)
...
/datum/reagent/toxin/sifslurry/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/toxin/sifslurry/overdose(mob/living/complex/M, alien, removed) // Overdose effect.
	if(alien == IS_DIONA)
		return
	if(ishuman(M))
		var/mob/living/complex/human/H = M
...
/datum/reagent/toxin/sifslurry/affect_ingest(mob/living/complex/M, alien, removed)
...
/datum/reagent/thermite/venom/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/condensedcapsaicin/venom/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
	if(prob(50))
...
/datum/reagent/lexorin/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
	if(alien == IS_SLIME)
...
/datum/reagent/mutagen/affect_touch(mob/living/complex/M, alien, removed)
	if(prob(33))
		affect_blood(M, alien, removed)

/datum/reagent/mutagen/affect_ingest(mob/living/complex/M, alien, removed)
	if(prob(67))
		affect_blood(M, alien, removed)

/datum/reagent/mutagen/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/slimejelly/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/advmutationtoxin/affect_blood(mob/living/complex/M, alien, removed)
	if(ishuman(M))
		var/mob/living/complex/human/H = M
...
/datum/reagent/soporific/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/chloralhydrate/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/chloralhydrate/overdose(mob/living/complex/M, alien, removed)
	..()
	M.SetLosebreath(10)
...
/datum/reagent/space_drugs/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/serotrotium/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
	if(prob(7))
...
/datum/reagent/serotrotium/venom/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
	if(prob(30))
		if(prob(25))
...
/datum/reagent/cryptobiolin/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
	var/drug_strength = 4
...
/datum/reagent/impedrezene/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/mindbreaker/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/psilocybin/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/talum_quem/affect_blood(mob/living/complex/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/slimetoxin/affect_blood(mob/living/complex/M, alien, removed)
	if(M.isSynthetic())
		return
...
/datum/reagent/aslimetoxin/affect_blood(mob/living/complex/M, alien, removed) // TODO: check if there's similar code anywhere else
	if(M.isSynthetic())
		return
...
/datum/reagent/shredding_nanites/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/irradiated_nanites/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/neurophage_nanites/affect_blood(mob/living/complex/M, alien, removed)
...
/datum/reagent/grubshock/affect_blood(mob/living/complex/M, alien, removed)
