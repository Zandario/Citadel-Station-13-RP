...
/datum/event/solar_storm/start()
	command_announcement.Announce("The emission has now reached the ship. Please refrain from EVA and remain inside the ship until it has passed.", "Anomaly Alert")
