...
/datum/event/ionstorm/get_skybox_image()
	...
	var/image/res = image('icons/screen/parallax/skybox/ionbox.dmi', "ions")
...
*/
	...
	for(var/mob/living/silicon/ai/M in living_mob_list)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			var/target = pick("a traitor", "a mercenary", "a changeling", "a wizard", "the head of a revolution", "Soviet spy", "a good person", "a dwarf", "an elf", "a fairy princess", "the Facility Director", "Beepsky", "God", "a pirate", "a gryphon", "a chryssalid")
			...
			switch(rand(1,14))
				...
				if(5)
					to_chat(M, "<br>")
					to_chat(M, "<font color='red'>THE Facility Director, HOP AND HOS ARE [who2]...LAWS UPDATED</font>")
					to_chat(M, "<br>")
