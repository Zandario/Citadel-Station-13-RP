...
/datum/nanoui
  ...
  */
/datum/nanoui/New(mob/nuser, nsrc_object, nui_key, ntemplate_filename, ntitle = 0, nwidth = 0, nheight = 0, atom/nref = null, datum/nanoui/master_ui = null, datum/topic_state/state = default_nano_state)
