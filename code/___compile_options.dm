...
// #define FASTBOOT_DISABLE_SMOOTHING (1<<0) // Disable automatic roundstart icon smoothing.
// #define FASTBOOT_DISABLE_LATELOAD  (1<<1) // Disable loading late maps.
// #define FASTBOOT_DISABLE_ZONES     (1<<2) // Disable atmospherics zone build.
