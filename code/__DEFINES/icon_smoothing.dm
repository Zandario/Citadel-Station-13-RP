...
/**
 *! Planned to be /turf/open, but we don't use those yet.
 * So for now, be smart with it.
 * @Zandario
 */
...
/**
 *! Planned to be /turf/closed, but we don't use those yet.
 * So for now, be smart with it.
 * @Zandario
 */
...
#define MAX_S_TURF SMOOTH_GROUP_CLOSED_TURFS //! Always match this value with the highest SMOOTH_GROUP_
...
#define MAX_S_OBJ SMOOTH_GROUP_SANDBAGS //! Always match this value with the highest SMOOTH_GROUP_
