//! ## LEGACY ROLE PREFS BELOW -- DO NOT ADD ONTO THEM. -Zandario
#define ROLE_TRAITOR    (1<<0)
#define ROLE_OPERATIVE  (1<<1)
#define ROLE_CHANGELING (1<<2)
#define ROLE_WIZARD     (1<<3)
#define ROLE_MALF       (1<<4)
#define ROLE_REV        (1<<5)
#define ROLE_ALIEN      (1<<6)
#define ROLE_AI         (1<<7)
#define ROLE_CULTIST    (1<<8)
#define ROLE_RENEGADE   (1<<9)
#define ROLE_NINJA      (1<<10)
#define ROLE_RAIDER     (1<<11)
#define ROLE_PLANT      (1<<12)
#define ROLE_MUTINEER   (1<<13)
#define ROLE_PAI        (1<<14)
#define ROLE_LOYALIST   (1<<15)

var/list/legacy_be_special_flags = list(
	"Traitor"          = ROLE_TRAITOR,
	"Operative"        = ROLE_OPERATIVE,
	"Changeling"       = ROLE_CHANGELING,
	"Wizard"           = ROLE_WIZARD,
	"Malf AI"          = ROLE_MALF,
	"Revolutionary"    = ROLE_REV,
	"Loyalist"         = ROLE_LOYALIST,
	"Xenomorph"        = ROLE_ALIEN,
	"Positronic Brain" = ROLE_AI,
	"Cultist"          = ROLE_CULTIST,
	"Renegade"         = ROLE_RENEGADE,
	"Ninja"            = ROLE_NINJA,
	"Raider"           = ROLE_RAIDER,
	"Diona"            = ROLE_PLANT,
	"Mutineer"         = ROLE_MUTINEER,
	"pAI"              = ROLE_PAI
)
