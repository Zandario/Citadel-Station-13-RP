...
#define NORMAL_LIGHTING_PLANE 11
#define NORMAL_LIGHTING_LAYER 0
#define NORMAL_LIGHTING_RENDER_TARGET "*NORMAL_PLANE"

#define NORMAL_POINT_MAP_PLANE 12
#define NORMAL_POINT_MAP_LAYER 0
#define NORMAL_POINT_MAP_RENDER_TARGET "*NORMAL_COMBINATION_PLANE"
