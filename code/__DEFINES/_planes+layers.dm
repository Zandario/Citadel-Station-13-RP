...
#define SPACE_PLANE -55

/// Reserved for use in space/parallax
#define PARALLAX_PLANE -50
...
#define PLANE_LOOKINGGLASS     -41
#define PLANE_LOOKINGGLASS_IMG -40
...
#define TURF_PLANE -5
	#define WATER_FLOOR_LAYER        2     // The 'bottom' of water tiles. //TODO: Remove this, this is just TURF_LAYER
	#define MID_TURF_LAYER           2.02
	#define HIGH_TURF_LAYER          2.03
	#define TURF_PLATING_DECAL_LAYER 2.031
	#define TURF_DECAL_LAYER         2.039 // For floors that automatically add decal overlays.
	#define CLOSED_TURF_LAYER        2.05
	#define UNDERWATER_LAYER         2.5   // Anything on this layer will render under the water layer.
	#define CATWALK_LAYER            2.51  // Just above water.
...
#define OBJ_PLANE -4
	...
	#define UNDER_OBJ_LAYER    2.9 // Things that want to be slightly below common objects.
