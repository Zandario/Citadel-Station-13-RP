...
#define COLOR_BROWN_ROCK "#735555"
 ...
 *
 *? Important note:
 * * colors can end up significantly different from the basic html picture, especially when saturated
 */

/// Bright and dull, just like the office wanted. rgb(255, 255, 255)
...
#define AMBIENT_OCCLUSION filter(type="drop_shadow", x=0, y=-1, size=2, offset=2, color="#04080FAA")
