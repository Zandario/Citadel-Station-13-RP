...
#define LIGHT_COLOR_FLUORESCENT_TUBE        "#B3D7FF" //! rgb(179, 215, 255) Bright, slightly blueish white.
#define LIGHT_COLOR_FLUORESCENT_FLASHLIGHT  "#CDDDFF" //! rgb(205, 221, 255) Bright, slightly blueish white.
