...
//! /mob/living/simple/hostile signals
...
/// From base of mob/living/simple/hostile/regalrat: (mob/living/simple/hostile/regalrat/king)
////#define COMSIG_RAT_INTERACT "rat_interaction"
/// From mob/living/simple/hostile/ooze/eat_atom(): (atom/target, edible_flags)
