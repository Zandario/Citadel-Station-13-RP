...
/// From base of /obj/item/bodypart/proc/drop_limb(lost_limb, dismembered)
////#define COMSIG_CARBON_REMOVE_LIMB "carbon_remove_limb"
/// From /obj/item/bodypart/proc/apply_gauze(/obj/item/stack/gauze)
