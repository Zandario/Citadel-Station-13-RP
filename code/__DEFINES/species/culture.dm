...
#define CULTURE_SERGALING "Sergaling Business"
#define CULTURE_SOBAKA "Sobaka Business"
#define CULTURE_SPARRA "Sparra Business"
#define CULTURE_STOK "Stok Business"
#define CULTURE_WOLPIN "Wolpin Business"
