 ...
 */
/datum/controller/subsystem/nanoui/proc/try_update_ui(mob/user, src_object, ui_key, datum/nanoui/ui, data, force_open = 0)
 ...
 * @return int The number of uis updated
 */
/datum/controller/subsystem/nanoui/proc/update_user_uis(mob/user, src_object = null, ui_key = null)
