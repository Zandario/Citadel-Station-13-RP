...
/datum/controller/subsystem/server_maint/fire(resumed = FALSE)
	...
	for(var/I in currentrun)
		...
		if(round_started && kick_inactive && !C.holder && C.is_afk(afk_period))
			...
			if(!(isobserver(cmob) || !isnewplayer(cmob)))
				...
				<br>[SPAN_DANGER("You may reconnect via the button in the file menu or by <b><u><a href='byond://winset?command=.reconnect'>clicking here to reconnect</a></u></b>.")]")
