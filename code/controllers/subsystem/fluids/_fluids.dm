...
/datum/controller/subsystem/fluids/fire(resumed)
	...
	while(currentrun.len)
		var/obj/fluid/to_spread = currentrun[currentrun.len]
		currentrun.len--
	...
	while(currentrun.len)
		var/obj/fluid/to_process = currentrun[currentrun.len]
		currentrun.len--
 ...
 *
 * Arguments:
 * - [node][/obj/fluid]: The node to queue to spread.
 */
/datum/controller/subsystem/fluids/proc/queue_spread(obj/fluid/node)
 ...
 *
 * Arguments:
 * - [node][/obj/fluid]: The node to cancel the spread of.
 */
/datum/controller/subsystem/fluids/proc/cancel_spread(obj/fluid/node)
	if(!node.spread_bucket)
		return
 ...
 *
 * Arguments:
 * - [node][/obj/fluid]: The node to start processing.
 */
/datum/controller/subsystem/fluids/proc/start_processing(obj/fluid/node)
 ...
 *
 * Arguments:
 * - [node][/obj/fluid]: The node to stop processing.
 */
/datum/controller/subsystem/fluids/proc/stop_processing(obj/fluid/node)
