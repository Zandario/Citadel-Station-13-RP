...
/turf/Entered(atom/movable/AM)
	...
	if(AM?.opacity && !blocks_light)
		blocks_light = -1 // Make sure to do this before reconsider_lights(), incase we're on instant updates. Guaranteed to be on in this case.
		update_all_lights()
