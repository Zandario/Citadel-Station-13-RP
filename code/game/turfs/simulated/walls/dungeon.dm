...
/turf/simulated/wall/solidrock/custom_smooth(dirs)
	...
	if(!(smoothing_junction & NORTH_JUNCTION))
		add_overlay(get_cached_rock_border("rock_side", NORTH, 'icons/turf/walls/walls.dmi', "rock_side"))
	if(!(smoothing_junction & SOUTH_JUNCTION))
		add_overlay(get_cached_rock_border("rock_side", SOUTH, 'icons/turf/walls/walls.dmi', "rock_side"))
	if(!(smoothing_junction & EAST_JUNCTION))
		add_overlay(get_cached_rock_border("rock_side", EAST, 'icons/turf/walls/walls.dmi', "rock_side"))
	if(!(smoothing_junction & WEST_JUNCTION))
		add_overlay(get_cached_rock_border("rock_side", WEST, 'icons/turf/walls/walls.dmi', "rock_side"))
