...
/turf/simulated/floor/water/update_icon()
	...
	var/image/water_sprite = image(icon = 'icons/turf/outdoors.dmi', icon_state = water_state, layer = FLOOD_LAYER)
...
/turf/simulated/floor/water/acid/update_icon()
	...
	icon_state = under_state // This isn't set at compile time in order for it to show as water in the map editor.
	var/image/acid_sprite = image(icon = 'icons/turf/outdoors.dmi', icon_state = acid_state, layer = FLOOD_LAYER)
...
/turf/simulated/floor/water/blood/update_icon()
	..()
	icon_state = under_state // This isn't set at compile time in order for it to show as water in the map editor.
	var/image/blood_sprite = image(icon = 'icons/turf/outdoors.dmi', icon_state = blood_state, layer = FLOOD_LAYER)
