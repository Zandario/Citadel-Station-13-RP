...
/datum/antagonist/traitor/equip(var/mob/living/complex/human/traitor_mob)
	...
	var/mob/living/complex/human/M = get_nt_opposed()
	if(M && M != traitor_mob)
...
/datum/antagonist/traitor/proc/spawn_uplink(var/mob/living/complex/human/traitor_mob)
