...
/datum/antagonist/proc/create_default(var/mob/source)
	...
	if(mob_path)
		...
		M = new /mob/living/complex/human(get_turf(source))
...
/datum/antagonist/proc/create_id(var/assignment, var/mob/living/complex/human/player, var/equip = 1)
...
/datum/antagonist/proc/create_radio(var/freq, var/mob/living/complex/human/player)
