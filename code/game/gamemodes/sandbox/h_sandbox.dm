	...
	proc
		update()
			...
			if(admin)
				...
				hsbpanel += "- <a href=\"byond://?\ref[src];hsb=hsbtobj\">Toggle Object Spawning</a><br><br>"
			hsbpanel += "<b>Regular Tools:</b><br>"
			for(var/T in hrefs)
				hsbpanel += "- <a href=\"byond://?\ref[src];hsb=[T]\">[hrefs[T]]</a><br>"
			if(hsboxspawn)
				hsbpanel += "- <a href=\"byond://?\ref[src];hsb=hsbobj\">Spawn Object</a><br><br>"
