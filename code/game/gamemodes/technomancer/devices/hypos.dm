datum/technomancer/consumable/hypo_brute
	...
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/brute

datum/technomancer/consumable/hypo_burn
	name = "Burn Hypo"
	desc = "A extended capacity hypo which can treat severe burns."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/burn

datum/technomancer/consumable/hypo_tox
	name = "Toxin Hypo"
	desc = "A extended capacity hypo which can treat various toxins."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/toxin

datum/technomancer/consumable/hypo_oxy
	name = "Oxy Hypo"
	desc = "A extended capacity hypo which can treat oxygen deprivation."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/oxy
...
datum/technomancer/consumable/hypo_purity
	...
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/purity

datum/technomancer/consumable/hypo_pain
	name = "Pain Hypo"
	desc = "A extended capacity hypo which contains potent painkillers."
	cost = 25
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/pain

datum/technomancer/consumable/hypo_organ
	name = "Organ Hypo"
	desc = "A extended capacity hypo which is designed to fix internal organ problems."
	cost = 50
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/organ
...
datum/technomancer/consumable/hypo_combat
	...
	cost = 75
	obj_path = /obj/item/reagent_containers/hypospray/autoinjector/biginjector/combat
