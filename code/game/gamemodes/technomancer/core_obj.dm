...
/mob/living/complex/human/technomancer_pay_energy(amount)
...
/obj/item/technomancer_core/proc/regenerate()
	...
	if(wearer && ishuman(wearer))
		var/mob/living/complex/human/H = wearer
...
/mob/living/complex/human/proc/technomancer_stat(obj/item/technomancer_core/core)
...
/mob/living/complex/human/proc/wiz_energy_update_hud()
	if(client && hud_used)
