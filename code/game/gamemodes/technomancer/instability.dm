...
/mob/living/complex/human/adjust_instability(var/amount)
	..()
...
/mob/living/complex/human/proc/instability_update_hud()
	if(client && hud_used)
		switch(instability)
			if(0 to 10)
...
/mob/living/complex/human/handle_instability()
	..()
	instability_update_hud()
...
/mob/living/complex/human/instability_effects()
	if(instability)
		var/rng = 0
		..()
		switch(instability)
