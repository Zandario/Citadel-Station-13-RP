...
/obj/structure/undies_wardrobe/interact(var/mob/living/complex/human/H)
	var/dat = list()
...
/obj/structure/undies_wardrobe/proc/get_metadata(var/mob/living/complex/human/H, var/underwear_category, var/datum/gear_tweak/gt)
...
/obj/structure/undies_wardrobe/proc/set_metadata(var/mob/living/complex/human/H, var/underwear_category, var/datum/gear_tweak/gt, var/new_metadata)
	var/list/metadata = H.all_underwear_metadata[underwear_category]
	metadata["[gt]"] = new_metadata

/obj/structure/undies_wardrobe/proc/human_who_can_use_underwear(var/mob/living/complex/human/H)
