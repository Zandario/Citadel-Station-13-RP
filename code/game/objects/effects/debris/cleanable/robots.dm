...
obj/effect/debris/cleanable/blood/gibs/robot/streak(var/list/directions)
	spawn (0)
		...
		for (var/i = 0, i < pick(1, 200; 2, 150; 3, 50; 4), i++)
			...
			if (i > 0)
				if (prob(40))
					var/obj/effect/debris/cleanable/blood/oil/streak = new(src.loc)
					streak.update_icon()
				else if (prob(10))
...
obj/effect/debris/cleanable/blood/gibs/robot/down
	random_icon_states = list("gib1", "gib2", "gib3", "gib4", "gib5", "gib6", "gib7","gibdown1","gibdown1") //2:7 is close enough to 1:4

obj/effect/debris/cleanable/blood/oil
	basecolor = SYNTH_BLOOD_COLOUR

obj/effect/debris/cleanable/blood/oil/dry()
	return
