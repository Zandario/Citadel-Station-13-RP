...
/obj/item/radio/headset/mob_headset/nano_ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1, var/state = interactive_nano_state)
	ui = new(user, src, ui_key, "radio_basic.tmpl", "[name]", 400, 430, state = interactive_nano_state)
	..()
