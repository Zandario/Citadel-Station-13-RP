...
/obj/machinery/computer/message_monitor
	...
	var/emag = FALSE	// When it is emagged.
	...
	switch(action)
		...
		if("send_message")
			...
			//Sender is faking as someone who exists
				...
				customrecepient.tnote.Add(list(list("sent" = TRUE, "owner" = "[PDARec.owner]", "job" = "[customjob]", "message" = "[custommessage]", "target" ="\ref[PDARec]")))
