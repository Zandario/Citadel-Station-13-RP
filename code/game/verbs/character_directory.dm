...
/datum/character_directory/ui_interact(mob/user, tgui/ui, tgui/parent_ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "CharacterDirectory", "Character Directory")
		ui.open()

/datum/character_directory/ui_data(mob/user, tgui/ui, datum/ui_state/state)
	var/list/data = ..()
...
/datum/character_directory/ui_static_data(mob/user, tgui/ui, datum/ui_state/state)
	var/list/data = ..()
...
/datum/character_directory/ui_act(action, list/params, tgui/ui)
	. = ..()
	if(.)
		return
