...
//	if(config_legacy.admin_tgs)
//		to_chat(src, "<span class='info'>Adminhelps are also sent through TGS to services like Discord. If no admins are available in game try anyway and an admin on TGS may see it and respond.</span>")
