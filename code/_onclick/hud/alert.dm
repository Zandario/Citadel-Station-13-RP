...
/atom/movable/screen/alert/too_much_co2/plant
...
/atom/movable/screen/alert/embeddedobject/Click()
	if(isliving(usr))
		var/mob/living/complex/human/M = usr
