...
/datum/outfit/death_command/equip(var/mob/living/complex/human/H)
	deathsquad.equip(H)
	return 1
...
/datum/outfit/syndicate_command/equip(var/mob/living/complex/human/H)
	commandos.equip(H)
	return 1
...
/datum/outfit/PARA/equip(var/mob/living/complex/human/H)
	. = ..()
	if(H.mind)
		H.mind.isholy = TRUE
