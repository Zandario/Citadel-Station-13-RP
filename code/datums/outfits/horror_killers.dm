...
/datum/outfit/masked_killer/post_equip(var/mob/living/complex/human/H)
...
/datum/outfit/professional/post_equip(var/mob/living/complex/human/H)
...
/datum/outfit/samurai/equip(var/mob/living/complex/human/H)
	. = ..()
	if(H.mind)
...
/datum/outfit/mummy/equip(var/mob/living/complex/human/H)
	. = ..()
	if(H.mind)
...
/datum/outfit/animegirl/post_equip(var/mob/living/complex/human/H)
	var/victim = get_mannequin(H.ckey)
	for(var/obj/item/carried_item in H.get_equipped_items(TRUE))
