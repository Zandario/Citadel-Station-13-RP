...
/datum/outfit/costume/masked_killer/post_equip(var/mob/living/complex/human/H)
...
/datum/outfit/costume/professional/post_equip(var/mob/living/complex/human/H)
...
/datum/outfit/costume/horrorcop/post_equip(var/mob/living/complex/human/H)
...
/datum/outfit/costume/cowboy/post_equip(var/mob/living/complex/human/H)
	var/obj/item/clothing/under/U = H.w_uniform
	if(LAZYLEN(U.accessories))
		for(var/obj/item/clothing/accessory/A in U.accessories)
			if(istype(A, /obj/item/clothing/accessory/holster))
