...
var/global/list/remainless_species = list(SPECIES_PROMETHEAN,
				...
				SPECIES_ALRAUNE,
				SPECIES_PROTEAN,
				SPECIES_HUMAN_MONKEY,					//Exclude all monkey subtypes, to prevent abuse of it. They aren't,
				SPECIES_TAJARA_MONKEY,				//set to have remains anyway, but making double sure,
				SPECIES_SKRELL_MONKEY,
				SPECIES_UNATHI_MONKEY,
				SPECIES_AKULA_MONKEY,
				SPECIES_NEVREAN_MONKEY,
				SPECIES_SERGAL_MONKEY,
				SPECIES_VULPKANIN_MONKEY,
