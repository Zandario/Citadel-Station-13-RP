 ...
 */
/color_matrix/New(mat, contrast = 1, brightness = null)
	. = ..()
 ...
 */
/color_matrix/proc/Get(contrast = 1)
 ...
 */
/color_matrix/proc/SetSaturation(s, c = 1, b = null)
 ...
 */
/color_matrix/proc/SetBrightness(brightness)
	if(brightness == null)
		return
 ...
 */
/color_matrix/proc/hex2value(hex)
 ...
 */
/color_matrix/proc/SetColor(color, contrast = 1, brightness = null)
 ...
 */
/color_matrix/proc/SetPreset(preset)
 ...
 */
/color_matrix/proc/Combine(list/mat)
	if(!matrix)
		return

	if(istype(mat, /color_matrix))
		mat = mat:matrix
 ...
 */
/color_matrix/proc/Split(list/mat)
	if(!matrix)
		return
