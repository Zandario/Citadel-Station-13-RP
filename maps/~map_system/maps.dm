...
/datum/map
	...
	var/lobby_icon = 'icons/screen/fullscreen/title.dmi'			// The icon which contains the lobby image(s)
	var/list/lobby_screens = list()	// The list of lobby screen to pick() from. If left unset a random icon state is always selected.
