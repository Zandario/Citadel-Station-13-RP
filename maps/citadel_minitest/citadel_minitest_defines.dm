...
/datum/map/citadel_minitest
	name      = "citadel_minitest"
	full_name = "NSS Citadel Testing Facility"
	path      = "citadel_minitest"

	lobby_icon    = 'icons/misc/title_vr.dmi'
	lobby_screens = list("minitest1", "minitest2")
	//TODO:@Zandario - Remove/Fix these unneccessary Override Overrides everywhere ffs.
	//CITADEL CHANGE: Ignore this line because it's going to be overriden in modular_citadel\maps\tether\tether_defines.dm
