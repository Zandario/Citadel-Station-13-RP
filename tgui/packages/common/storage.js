...
class HubStorageBackend {
  ...
  get(key) {
    const value = window.hubStorage.getItem('citadelrp-' + key);
  ...
  set(key, value) {
    window.hubStorage.setItem('citadelrp-' + key, JSON.stringify(value));
  }

  remove(key) {
    window.hubStorage.removeItem('citadelrp-' + key);
  }
